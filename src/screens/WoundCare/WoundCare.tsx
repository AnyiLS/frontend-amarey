				...
				<React.Fragment>
					{
						...
						<defs>
							<style>
								{
									'.a-products-heridas-desktop,.b-products-heridas-desktop{stroke:#707070;}.a-products-heridas-desktop{fill:url(#a-products-heridas-desktop);}.b-products-heridas-desktop,.g-products-heridas-desktop{opacity:0.5;}.b-products-heridas-desktop{mix-blend-mode:multiply;isolation:isolate;fill:url(#b-products-heridas-desktop);}.c-products-heridas-desktop,.d-products-heridas-desktop,.f-products-heridas-desktop,.i-products-heridas-desktop,.j-products-heridas-desktop{fill:#fff;}.c-products-heridas-desktop{font-size:55px;}.c-products-heridas-desktop,.f-products-heridas-desktop{font-family:"Kiona-Bold";font-weight:700;}.d-products-heridas-desktop,.j-products-heridas-desktop{font-size:24px;}.d-products-heridas-desktop{font-family:Silka-Regular, Silka;}.e-products-heridas-desktop{fill:rgba(67,67,67,0.09);}.f-products-heridas-desktop{font-size:42px;}.h-products-heridas-desktop{fill:rgba(255,255,255,0.5);}.j-products-heridas-desktop{font-family:Silka-SemiBold, Silka;font-weight:600;}.k-products-heridas-desktop{stroke:none;}.l-products-heridas-desktop{fill:none;}.m-products-heridas-desktop{filter:url(#c-products-heridas-desktop);}'
								}
							</style>
							<pattern
