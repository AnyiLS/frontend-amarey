			...
			{view === 0 ? (
				<svg viewBox="0 0 414 855">
					...
					<g>
						...
						<g transform="translate(368.125 13.292)">
							<path
								className="a-reward-2-mobile"
						...
						<g transform="translate(93.539 771.493)" onClick={() => setView(1)}>
							<g
				...
				<svg viewBox="0 0 414 855">
					<defs>
						<style>
							{
								'.a-reward-2-mobile,.e-reward-2-mobile,.l-reward-2-mobile,.n-reward-2-mobile,.r-reward-2-mobile,.u-reward-2-mobile{fill:#fff;}.b-reward-2-mobile{fill:url(#a-reward-2-mobile);}.c-reward-2-mobile{mix-blend-mode:multiply;isolation:isolate;fill:url(#b-reward-2-mobile);}.d-reward-2-mobile{fill:rgba(67,67,67,0.09);}.e-reward-2-mobile{font-size:24px;}.e-reward-2-mobile,.n-reward-2-mobile{font-family:Kiona-Bold, Kiona;}.e-reward-2-mobile,.i-reward-2-mobile,.n-reward-2-mobile{font-weight:700;}.f-reward-2-mobile,.g-reward-2-mobile,.k-reward-2-mobile,.q-reward-2-mobile{fill:#001f5f;}.f-reward-2-mobile,.g-reward-2-mobile{font-size:14px;}.f-reward-2-mobile,.h-reward-2-mobile,.r-reward-2-mobile,.u-reward-2-mobile{font-family:Silka-Regular, Silka;}.g-reward-2-mobile{font-family:Silka-SemiBold, Silka;font-weight:600;}.h-reward-2-mobile{font-weight:400;}.i-reward-2-mobile,.m-reward-2-mobile{fill:#e40032;}.i-reward-2-mobile{font-size:16px;font-family:Silka-Bold, Silka;}.j-reward-2-mobile{opacity:0.7;}.l-reward-2-mobile{opacity:0.4;}.n-reward-2-mobile{font-size:18px;}.o-reward-2-mobile{clip-path:url(#e-reward-2-mobile);}.p-reward-2-mobile{fill:#e7002a;stroke:#e7002a;}.q-reward-2-mobile{stroke:#001f5f;}.r-reward-2-mobile,.u-reward-2-mobile{font-size:12px;}.s-reward-2-mobile{clip-path:url(#f-reward-2-mobile);}.t-reward-2-mobile,.u-reward-2-mobile{text-decoration:underline;}.v-reward-2-mobile{filter:url(#c-reward-2-mobile);}'
							}
						</style>
						<pattern
							id="a-reward-2-mobile"
				...
				<svg viewBox="0 0 414 855">
					...
					<g>
						...
						<g
							className="i-reward-2-mobile"
							transform="translate(184 836.024) rotate(-90)" onClick={() => setView(0)}>
							<circle
								className="j-reward-2-mobile"
								cx={22}
								cy={22}
