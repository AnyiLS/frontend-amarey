	...
	return (
		<React.Fragment>
			{view === 0 ? (
				...
				<svg viewBox="0 0 414 857">
					<defs>
						<style>
							{
								'.a-reward-2-mobile,.f-reward-2-mobile,.j-reward-2-mobile,.o-reward-2-mobile{fill:#fff;}.b-reward-2-mobile{fill:none;}.c-reward-2-mobile{fill:url(#a-reward-2-mobile);}.d-reward-2-mobile{mix-blend-mode:multiply;isolation:isolate;fill:url(#b-reward-2-mobile);}.e-reward-2-mobile{fill:rgba(67,67,67,0.09);}.f-reward-2-mobile{font-size:24px;}.f-reward-2-mobile,.o-reward-2-mobile{font-family:Kiona-Bold, Kiona;font-weight:700;}.g-reward-2-mobile,.i-reward-2-mobile,.m-reward-2-mobile{fill:#001f5f;}.g-reward-2-mobile{font-size:14px;font-family:Silka-Regular, Silka;}.h-reward-2-mobile{opacity:0.7;}.j-reward-2-mobile{opacity:0.4;}.k-reward-2-mobile{clip-path:url(#e-reward-2-mobile);}.l-reward-2-mobile{clip-path:url(#f-reward-2-mobile);}.m-reward-2-mobile{stroke:#001f5f;}.n-reward-2-mobile{fill:#e7002a;stroke:#e7002a;}.o-reward-2-mobile{font-size:18px;}.p-reward-2-mobile{filter:url(#c-reward-2-mobile);}'
							}
						</style>
						<pattern
							id="a-reward-2-mobile"
					...
					<g>
						...
						<text
							...
							<tspan x={0} y={67}>
								{'hemorrágico (aneurisma), donde el '}
							</tspan>
							<tspan x={0} y={85}>
								{
							...
							<tspan x={0} y={103}>
								{'va consolidando como alternativa para '}
							</tspan>
							<tspan x={0} y={121}>
								{'determinados casos. '}
							</tspan>
							...
							<tspan x={0} y={193}>
								{'ACCESO, una gran variedad de Coils y una '}
							</tspan>
							<tspan x={0} y={211}>
								{
							...
							<tspan x={0} y={265}>
								{'para los requerimientos de tiempo y '}
							</tspan>
							<tspan x={0} y={283}>
								{
