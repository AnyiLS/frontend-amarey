	...
	return (
		<svg viewBox="165 39 414 949.512">
			<defs>
				<style>
					{
						'.a-reward-2-mobile,.c-reward-2-mobile{fill:#e40032;}.b-reward-2-mobile,.k-reward-2-mobile{fill:#fff;}.c-reward-2-mobile{stroke:#e40032;}.d-reward-2-mobile,.h-reward-2-mobile,.i-reward-2-mobile,.j-reward-2-mobile{fill:#001f5f;}.d-reward-2-mobile{stroke:#001f5f;}.e-reward-2-mobile{clip-path:url(#a-reward-2-mobile);}.f-reward-2-mobile{clip-path:url(#b-reward-2-mobile);}.g-reward-2-mobile{fill:url(#c-reward-2-mobile);}.h-reward-2-mobile{font-size:14px;font-family:Silka-Regular, Silka;}.i-reward-2-mobile{font-size:32px;}.i-reward-2-mobile,.k-reward-2-mobile{font-family:Kiona-Bold, Kiona;font-weight:700;}.k-reward-2-mobile{font-size:18px;}.l-reward-2-mobile{fill:rgba(67,67,67,0.3);}.m-reward-2-mobile{filter:url(#h-reward-2-mobile);}.n-reward-2-mobile{filter:url(#f-reward-2-mobile);}.o-reward-2-mobile{filter:url(#d-reward-2-mobile);}'
					}
				</style>
