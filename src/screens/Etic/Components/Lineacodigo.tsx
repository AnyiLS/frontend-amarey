      ...
      {!showPop ? (
        <svg viewBox="0 0 1938 975">
          <defs>
            ...
            <clipPath id="c-linea">
              <rect className="b-linea" width={272.39} height={138.127} />
            </clipPath>
            <filter
              id="d-linea"
              x={830}
          ...
          <g>
            ...
            >
              <path
                className="c-linea cursor-pointer"
                d="M798.177,0,695.867,662.362c-29.32,189.821-98.5,313.627-175.229,313.627H0V0Z"
                transform="translate(36)"
              />
            </g>
            <g transform={selectedLanguage === 'es' ? 'translate(-36 1)' : 'translate(-36 -70)'}>
              <path
            ...
            <text className="k-linea" transform="translate(692 219.271)">
              <tspan x={0} y={55}>
                {t("L\xEDnea \xE9tica")}
              </tspan>
            </text>
            <text className="l-linea" transform="translate(692 335.868)">
              <tspan x={0} y={23}>
                {t(
            ...
            <text className="m-linea" transform="translate(692 607.434)">
              <tspan x={0} y={30}>
            ...
            >
              ...
              >
                <path
                  className="j-linea cursor-pointer"
              ...
              <text
                className="n-linea cursor-pointer"
            ...
            <g transform="translate(8 1)">
              <g className="q-linea" transform="matrix(1, 0, 0, 1, -9, -6)">
                {/* <rect
                  className="o-linea"
                  width={1945}
                  height={74}
            ...
            <text className="p-linea" transform="translate(693.578 11.566)">
              <tspan x={43.834} y={42}>
