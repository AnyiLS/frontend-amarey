	...
	return (
		<svg viewBox="0 40 414 855">
			<defs>
				<style>
					{
						'.a-reward-2-mobile,.i-reward-2-mobile{fill:#e40032;}.b-reward-2-mobile,.e-reward-2-mobile,.l-reward-2-mobile,.n-reward-2-mobile,.p-reward-2-mobile,.q-reward-2-mobile,.r-reward-2-mobile{fill:#fff;}.c-reward-2-mobile{fill:none;}.d-reward-2-mobile,.j-reward-2-mobile,.k-reward-2-mobile{fill:#001f5f;}.d-reward-2-mobile{stroke:#001f5f;}.e-reward-2-mobile{font-size:18px;font-family:Kiona-Bold, Kiona;}.e-reward-2-mobile,.i-reward-2-mobile,.p-reward-2-mobile,.r-reward-2-mobile{font-weight:700;}.f-reward-2-mobile{clip-path:url(#a-reward-2-mobile);}.g-reward-2-mobile{clip-path:url(#b-reward-2-mobile);}.h-reward-2-mobile{fill:url(#c-reward-2-mobile);}.i-reward-2-mobile{font-size:16px;}.i-reward-2-mobile,.p-reward-2-mobile{font-family:Silka-Bold, Silka;}.j-reward-2-mobile,.l-reward-2-mobile{font-size:14px;font-family:Silka-Regular, Silka;}.m-reward-2-mobile{fill:rgba(67,67,67,0.3);}.n-reward-2-mobile{opacity:0.56;}.o-reward-2-mobile{clip-path:url(#t-reward-2-mobile);}.p-reward-2-mobile{font-size:21px;}.q-reward-2-mobile{opacity:0.36;}.r-reward-2-mobile{font-size:25px;font-family:Helvetica-Bold, Helvetica;}.s-reward-2-mobile{filter:url(#u-reward-2-mobile);}.t-reward-2-mobile{filter:url(#r-reward-2-mobile);}.u-reward-2-mobile{filter:url(#p-reward-2-mobile);}.v-reward-2-mobile{filter:url(#n-reward-2-mobile);}.w-reward-2-mobile{filter:url(#l-reward-2-mobile);}.x-reward-2-mobile{filter:url(#j-reward-2-mobile);}.y-reward-2-mobile{filter:url(#h-reward-2-mobile);}.z-reward-2-mobile{filter:url(#f-reward-2-mobile);}.aa-reward-2-mobile{filter:url(#d-reward-2-mobile);}'
					}
				</style>
				...
				<clipPath id="t-reward-2-mobile">
					<rect className="c-reward-2-mobile" width={341.08} height={492.379} />
				</clipPath>
				<filter
			...
			<g>
				...
				<text className="e-reward-2-mobile" transform="translate(207 65)">
					<tspan x={-95.733} y={0}>
						{'ÉTICA Y COMPLIANCE'}
					</tspan>
				</text>
				...
				<text className="i-reward-2-mobile" transform="translate(180 261)">
					<tspan x={-145.008} y={15}>
						{'¿Cuándo debo utilizar la línea ética?'}
					</tspan>
				</text>
				<text className="j-reward-2-mobile" transform="translate(37 291)">
					<tspan x={0} y={13}>
				...
				<g transform="translate(80 366)">
					<g className="aa-reward-2-mobile" transform="matrix(1, 0, 0, 1, -89, -366)">
						<path
				...
				<g transform="translate(80 573)">
					<g className="z-reward-2-mobile" transform="matrix(1, 0, 0, 1, -89, -573)">
						<path
							className="k-reward-2-mobile"
							d="M200.4,48.772H9.513C4.259,48.772,0,45.481,0,41.42V7.351C0,3.292,4.259,0,9.513,0H244.487C249.741,0,254,3.292,254,7.351c0,22.876-24,41.421-53.6,41.421"
				...
				<g transform="translate(80 435)">
					<g className="y-reward-2-mobile" transform="matrix(1, 0, 0, 1, -89, -435)">
						<path
							className="k-reward-2-mobile"
							d="M200.4,48.772H9.513C4.259,48.772,0,45.481,0,41.42V7.351C0,3.292,4.259,0,9.513,0H244.487C249.741,0,254,3.292,254,7.351c0,22.876-24,41.421-53.6,41.421"
				...
				<g transform="translate(80 642)">
					<g className="x-reward-2-mobile" transform="matrix(1, 0, 0, 1, -89, -642)">
						<path
							className="k-reward-2-mobile"
							d="M200.4,48.772H9.513C4.259,48.772,0,45.481,0,41.42V7.351C0,3.292,4.259,0,9.513,0H244.487C249.741,0,254,3.292,254,7.351c0,22.876-24,41.421-53.6,41.421"
				...
				<g transform="translate(80 504)">
					<g className="w-reward-2-mobile" transform="matrix(1, 0, 0, 1, -89, -504)">
						<path
							className="k-reward-2-mobile"
							d="M200.4,48.772H9.513C4.259,48.772,0,45.481,0,41.42V7.351C0,3.292,4.259,0,9.513,0H244.487C249.741,0,254,3.292,254,7.351c0,22.876-24,41.421-53.6,41.421"
				...
				<g transform="translate(80 711)">
					<g className="v-reward-2-mobile" transform="matrix(1, 0, 0, 1, -89, -711)">
						<path
							className="k-reward-2-mobile"
							d="M200.4,48.772H9.513C4.259,48.772,0,45.481,0,41.42V7.351C0,3.292,4.259,0,9.513,0H244.487C249.741,0,254,3.292,254,7.351c0,22.876-24,41.421-53.6,41.421"
				...
				<g transform="translate(80 780)">
					<g className="u-reward-2-mobile" transform="matrix(1, 0, 0, 1, -89, -780)">
						<path
							className="k-reward-2-mobile"
							d="M200.4,48.772H9.513C4.259,48.772,0,45.481,0,41.42V7.351C0,3.292,4.259,0,9.513,0H244.487C249.741,0,254,3.292,254,7.351c0,22.876-24,41.421-53.6,41.421"
				...
				<g className="t-reward-2-mobile" transform="matrix(1, 0, 0, 1, -9, 0)">
					<rect
				...
				<g transform="translate(331.23 240.163)" onClick={() => onNext(3)}>
					...
					<text className="r-reward-2-mobile" transform="translate(10.85 28.837)">
						<tspan x={0} y={0}>
							{'X'}
						</tspan>
					</text>
