...
const View11: React.FC<IEtic> = ({ onNext }): JSX.Element => {
	return (
		<svg viewBox="0 40 414 855">
			<defs>
				<style>
					{
						'.a-reward-2-mobile,.i-reward-2-mobile{fill:#e40032;}.b-reward-2-mobile,.e-reward-2-mobile,.l-reward-2-mobile,.n-reward-2-mobile,.p-reward-2-mobile,.q-reward-2-mobile,.r-reward-2-mobile{fill:#fff;}.c-reward-2-mobile{fill:none;}.d-reward-2-mobile,.j-reward-2-mobile,.k-reward-2-mobile{fill:#001f5f;}.d-reward-2-mobile{stroke:#001f5f;}.e-reward-2-mobile{font-size:18px;font-family:Kiona-Bold, Kiona;}.e-reward-2-mobile,.i-reward-2-mobile,.p-reward-2-mobile,.r-reward-2-mobile{font-weight:700;}.f-reward-2-mobile{clip-path:url(#a-reward-2-mobile);}.g-reward-2-mobile{clip-path:url(#b-reward-2-mobile);}.h-reward-2-mobile{fill:url(#c-reward-2-mobile);}.i-reward-2-mobile{font-size:16px;}.i-reward-2-mobile,.p-reward-2-mobile{font-family:Silka-Bold, Silka;}.j-reward-2-mobile,.l-reward-2-mobile{font-size:14px;font-family:Silka-Regular, Silka;}.m-reward-2-mobile{fill:rgba(67,67,67,0.3);}.n-reward-2-mobile{stroke:#707070;opacity:0.56;}.o-reward-2-mobile{clip-path:url(#t-reward-2-mobile);}.p-reward-2-mobile{font-size:21px;}.q-reward-2-mobile{opacity:0.36;}.r-reward-2-mobile{font-size:25px;font-family:Helvetica-Bold, Helvetica;}.s-reward-2-mobile{stroke:none;}.t-reward-2-mobile{filter:url(#u-reward-2-mobile);}.u-reward-2-mobile{filter:url(#r-reward-2-mobile);}.v-reward-2-mobile{filter:url(#p-reward-2-mobile);}.w-reward-2-mobile{filter:url(#n-reward-2-mobile);}.x-reward-2-mobile{filter:url(#l-reward-2-mobile);}.y-reward-2-mobile{filter:url(#j-reward-2-mobile);}.z-reward-2-mobile{filter:url(#h-reward-2-mobile);}.aa-reward-2-mobile{filter:url(#f-reward-2-mobile);}.ab-reward-2-mobile{filter:url(#d-reward-2-mobile);}'
					}
				</style>
