			...
			{view === 0 ? (
				<svg viewBox="0 0 414 855" width='100%' style={{ height: `calc(100vh - ${height}px)` }} preserveAspectRatio='none'>
					<defs>
						<style>
							{
								'.a-reward-2-mobile{fill:url(#a-reward-2-mobile);}.b-reward-2-mobile{mix-blend-mode:multiply;isolation:isolate;fill:url(#b-reward-2-mobile);}.c-reward-2-mobile,.d-reward-2-mobile,.f-reward-2-mobile,.g-reward-2-mobile,.h-reward-2-mobile{fill:#fff;}.c-reward-2-mobile{font-size:24px;}.c-reward-2-mobile,.f-reward-2-mobile{font-family:Kiona-Bold, Kiona;font-weight:700;}.d-reward-2-mobile{font-size:14px;font-family:Silka-Regular, Silka;}.e-reward-2-mobile{fill:rgba(67,67,67,0.09);}.f-reward-2-mobile{font-size:18px;}.h-reward-2-mobile{opacity:0.4;}.i-reward-2-mobile{filter:url(#e-reward-2-mobile);}.j-reward-2-mobile{filter:url(#c-reward-2-mobile);}'
							}
						</style>
						<pattern
