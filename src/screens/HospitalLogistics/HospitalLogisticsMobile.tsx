			...
			{view === 0 ? (
				...
				<svg viewBox="10 0 414 855" width='100%' style={{ height: `calc(100vh - ${height}px)` }} preserveAspectRatio='none'>
					<defs>
						<style>
							{
								'.a-reward-2-mobile,.l-reward-2-mobile,.q-reward-2-mobile{fill:#fff;}.b-reward-2-mobile{fill:none;}.c-reward-2-mobile{fill:url(#a-reward-2-mobile);}.d-reward-2-mobile{mix-blend-mode:multiply;isolation:isolate;fill:url(#b-reward-2-mobile);}.e-reward-2-mobile{fill:rgba(67,67,67,0.09);}.f-reward-2-mobile,.g-reward-2-mobile,.k-reward-2-mobile,.o-reward-2-mobile{fill:#001f5f;}.f-reward-2-mobile{font-size:24px;}.f-reward-2-mobile,.q-reward-2-mobile{font-family:Kiona-Bold;}.f-reward-2-mobile,.i-reward-2-mobile,.q-reward-2-mobile{font-weight:700;}.g-reward-2-mobile{font-size:14px;font-family:Silka-Regular, Silka;}.h-reward-2-mobile{font-family:Silka-MediumItalic, Silka;font-weight:500;font-style:italic;}.i-reward-2-mobile{font-family:Silka-Bold, Silka;}.j-reward-2-mobile{opacity:0.7;}.l-reward-2-mobile{opacity:0.4;}.m-reward-2-mobile{clip-path:url(#e-reward-2-mobile);}.n-reward-2-mobile{clip-path:url(#f-reward-2-mobile);}.o-reward-2-mobile{stroke:#001f5f;}.p-reward-2-mobile{fill:#e7002a;stroke:#e7002a;}.q-reward-2-mobile{font-size:18px;}.r-reward-2-mobile{filter:url(#c-reward-2-mobile);}'
							}
						</style>
						<pattern
							id="a-reward-2-mobile"
