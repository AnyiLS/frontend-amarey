			...
			{view === 0 ? (
				<svg viewBox="0 0 414 855">
					<defs>
						<style>
							{
								'.a-reward-2-mobile,.d-reward-2-mobile,.e-reward-2-mobile,.g-reward-2-mobile,.h-reward-2-mobile{fill:#fff;}.b-reward-2-mobile{fill:url(#a-reward-2-mobile);}.c-reward-2-mobile{mix-blend-mode:multiply;isolation:isolate;fill:url(#b-reward-2-mobile);}.d-reward-2-mobile{font-size:24px;}.d-reward-2-mobile,.g-reward-2-mobile{font-family:Kiona-Bold, Kiona;font-weight:700;}.e-reward-2-mobile{font-size:14px;font-family:Silka-Regular, Silka;}.f-reward-2-mobile{fill:rgba(67,67,67,0.09);}.g-reward-2-mobile{font-size:18px;}.h-reward-2-mobile{opacity:0.4;}.i-reward-2-mobile{filter:url(#e-reward-2-mobile);}.j-reward-2-mobile{filter:url(#c-reward-2-mobile);}'
							}
						</style>
						<pattern
				...
				<svg viewBox="10 0 414 855">
					<defs>
						<style>
							{
								'.a-reward-2-mobile,.l-reward-2-mobile,.q-reward-2-mobile{fill:#fff;}.b-reward-2-mobile{fill:none;}.c-reward-2-mobile{fill:url(#a-reward-2-mobile);}.d-reward-2-mobile{mix-blend-mode:multiply;isolation:isolate;fill:url(#b-reward-2-mobile);}.e-reward-2-mobile{fill:rgba(67,67,67,0.09);}.f-reward-2-mobile,.g-reward-2-mobile,.k-reward-2-mobile,.o-reward-2-mobile{fill:#001f5f;}.f-reward-2-mobile{font-size:24px;}.f-reward-2-mobile,.q-reward-2-mobile{font-family:Kiona-Bold, Kiona;}.f-reward-2-mobile,.i-reward-2-mobile,.q-reward-2-mobile{font-weight:700;}.g-reward-2-mobile{font-size:14px;font-family:Silka-Regular, Silka;}.h-reward-2-mobile{font-family:Silka-MediumItalic, Silka;font-weight:500;font-style:italic;}.i-reward-2-mobile{font-family:Silka-Bold, Silka;}.j-reward-2-mobile{opacity:0.7;}.l-reward-2-mobile{opacity:0.4;}.m-reward-2-mobile{clip-path:url(#e-reward-2-mobile);}.n-reward-2-mobile{clip-path:url(#f-reward-2-mobile);}.o-reward-2-mobile{stroke:#001f5f;}.p-reward-2-mobile{fill:#e7002a;stroke:#e7002a;}.q-reward-2-mobile{font-size:18px;}.r-reward-2-mobile{filter:url(#c-reward-2-mobile);}'
							}
						</style>
						<pattern
							id="a-reward-2-mobile"
							width={1}
							height={1}
							viewBox="167.367 0 644.668 1332.936">
							<image
								preserveAspectRatio="xMidYMid slice"
								width={1141.333}
								height={856}
					...
					<g>
						...
						<path
							className="a-reward-2-mobile"
							d="M10,0H404a10,10,0,0,1,10,10V321a0,0,0,0,1,0,0H0a0,0,0,0,1,0,0V10A10,10,0,0,1,10,0Z"
							transform="translate(8 535)"
						/>
						<g
								...
								<g transform="translate(423.485 0) rotate(90)">
									<g className="n-reward-2-mobile">
										...
										<path
											...
											transform="matrix(-0.966, -0.259, 0.259, -0.966, 198.095, 476.233)"
										/>
									</g>
								</g>
							</g>
				...
				<svg viewBox="0 0 414 862">
					<defs>
						...
						<pattern
							...
							width={1}
							height={1}
							viewBox="362.271 0 726.188 1505.125">
							<image
								preserveAspectRatio="xMidYMid slice"
								width={1284}
								height={856}
...
export default HospitalLogisticsMobile
