	...
	return (
		<div>
			<svg
				...
				<text className="g-selected" transform="translate(333.287 495)">
					<tspan x={0} y={0}>
						{t('ORTOPEDIA')}
					</tspan>
				</text>
				...
				<text className="i-selected" transform="translate(333.287 536)">
					...
					<tspan x={0} y={51}>
						{t('ortopedia ofrece disponibilidad 24/7 los ')}
					</tspan>
					<tspan x={0} y={79}>
						{t('365 d\xEDas del a\xF1o, con un servicio que ')}
					</tspan>
					<tspan x={0} y={107}>
						{t('ofrece acompa\xF1amiento en el quir\xF3fano ')}
					</tspan>
					<tspan x={0} y={135}>
						{t('y servicio posventa. ')}
					</tspan>
					<tspan x={0} y={163} />
					<tspan x={0} y={191}>
						{t('Contamos con una red log\xEDstica de ')}
					</tspan>
					<tspan x={0} y={219}>
						{t('ortopedia para atenci\xF3n de cirug\xEDas en ')}
					</tspan>
					<tspan x={0} y={247}>
						{t('ciudades principales e intermedias de ')}
					</tspan>
					<tspan x={0} y={275}>
						{t('Colombia y Costa Rica. ')}
					</tspan>
				</text>
				...
				<circle
					onClick={onClose}
					className="l-selected cursor-pointer"
					cx={27}
					cy={27}
					r={27}
				...
				<path
					onClick={onClose}
					className="a-selected cursor-pointer"
