...
const Reward10Mobile: React.FC = (): JSX.Element => {
	/** States */
	const [showCard, setShowCard] = React.useState<boolean>(false)

	return (
		<g
			transform="translate(-25 1601)"
			onClick={() => setShowCard(!showCard)}>
			{!showCard ? (
				<React.Fragment>
					<g
						className="dj-time-line"
						transform="matrix(1, 0, 0, 1, -66.98, -970.37)">
						<rect
							className="a-time-line"
							width={120}
							height={141}
							rx={8}
							transform="translate(66.98 970.37)"
						/>
					</g>
				...
				<React.Fragment>
					<defs>
						<style>
							{
								'.a-reward-10-mobile{fill:none;}.b-reward-10-mobile{fill:#001f5f;}.c-reward-10-mobile,.d-reward-10-mobile{fill:#fff;font-size:10px;}.c-reward-10-mobile{font-family:Silka-SemiBold, Silka;font-weight:600;}.d-reward-10-mobile{font-family:Silka-Regular, Silka;}.e-reward-10-mobile{clip-path:url(#c-reward-10-mobile);}.f-reward-10-mobile{fill:#f2f2f2;}.g-reward-10-mobile{fill:#e6e6e6;}.h-reward-10-mobile{fill:#ccc;}.i-reward-10-mobile{opacity:0.4;mix-blend-mode:multiply;isolation:isolate;}.j-reward-10-mobile{clip-path:url(#e-reward-10-mobile);}.k-reward-10-mobile{clip-path:url(#f-reward-10-mobile);}.l-reward-10-mobile{fill:#e7002a;}.m-reward-10-mobile{filter:url(#a-reward-10-mobile);}'
							}
						</style>
						<filter
							id="a-reward-10-mobile"
							x={0}
							y={0}
							width={138}
							height={159}
						...
						<clipPath id="c-reward-10-mobile">
							<rect
								className="a-reward-10-mobile"
								width={38}
								height={33.933}
							/>
						</clipPath>
						<clipPath id="e-reward-10-mobile">
							<rect
								className="a-reward-10-mobile"
								width={31.529}
								height={3.548}
						...
						<clipPath id="f-reward-10-mobile">
							<rect
								className="a-reward-10-mobile"
								width={29.824}
								height={2.479}
					...
					<g>
						<g
							className="m-reward-10-mobile"
							transform="matrix(1, 0, 0, 1, -9, -6)">
							<rect
								className="b-reward-10-mobile"
								width={120}
								height={141}
								rx={8}
						...
						<text
							className="d-reward-10-mobile"
							transform="translate(9.5 83)">
							<tspan x={5.71} y={9}>
								{'Mención de honor '}
							</tspan>
							<tspan x={7.285} y={21}>
						...
						<g transform="translate(37.43 15.465)">
							<g
								className="e-reward-10-mobile"
								transform="translate(3.57 -1)">
								<g className="e-reward-10-mobile">
									<path
										className="f-reward-10-mobile"
									...
									/>
									<g
										className="i-reward-10-mobile"
										transform="translate(3.208 27.847)">
										<g className="j-reward-10-mobile">
											<path
												className="h-reward-10-mobile"
									...
									<g
										...
										<g className="k-reward-10-mobile">
											<path
												className="h-reward-10-mobile"
