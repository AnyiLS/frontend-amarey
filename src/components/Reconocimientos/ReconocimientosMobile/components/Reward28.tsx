...
const Reward28Mobile: React.FC = (): JSX.Element => {
	/** States */
	const [showCard, setShowCard] = React.useState<boolean>(false)

	return (
		<g
			transform="translate(-24 2537)"
			onClick={() => setShowCard(!showCard)}>
			{!showCard ? (
				<React.Fragment>
					<g
						className="dr-time-line"
						transform="matrix(1, 0, 0, 1, -67.98, -1906.37)">
						<rect
							className="a-time-line"
							width={120}
							height={141}
							rx={8}
							transform="translate(67.98 1906.37)"
						/>
					</g>
				...
				<React.Fragment>
					<defs>
						<style>
							{
								'.a-reward-28-mobile{fill:none;}.b-reward-28-mobile{fill:#001f5f;}.c-reward-28-mobile,.d-reward-28-mobile{fill:#fff;font-size:10px;}.c-reward-28-mobile{font-family:Silka-SemiBold, Silka;font-weight:600;}.d-reward-28-mobile{font-family:Silka-Regular, Silka;}.e-reward-28-mobile{clip-path:url(#c-reward-28-mobile);}.f-reward-28-mobile{fill:#f2f2f2;}.g-reward-28-mobile{fill:#e6e6e6;}.h-reward-28-mobile{fill:#ccc;}.i-reward-28-mobile{opacity:0.4;mix-blend-mode:multiply;isolation:isolate;}.j-reward-28-mobile{clip-path:url(#e-reward-28-mobile);}.k-reward-28-mobile{clip-path:url(#f-reward-28-mobile);}.l-reward-28-mobile{fill:#e7002a;}.m-reward-28-mobile{filter:url(#a-reward-28-mobile);}'
							}
						</style>
						<filter
							id="a-reward-28-mobile"
							x={0}
							y={0}
							width={138}
							height={159}
						...
						<clipPath id="c-reward-28-mobile">
							<rect
								className="a-reward-28-mobile"
								width={38}
								height={33.933}
							/>
						</clipPath>
						<clipPath id="e-reward-28-mobile">
							<rect
								className="a-reward-28-mobile"
								width={31.529}
								height={3.548}
						...
						<clipPath id="f-reward-28-mobile">
							<rect
								className="a-reward-28-mobile"
								width={29.824}
								height={2.479}
					...
					<g>
						<g
							className="m-reward-28-mobile"
							transform="matrix(1, 0, 0, 1, -9, -6)">
							<rect
								className="b-reward-28-mobile"
								width={120}
								height={141}
								rx={8}
						...
						<text
							className="d-reward-28-mobile"
							transform="translate(26.5 85.5)">
							<tspan x={8.58} y={9}>
								{'Partner of '}
							</tspan>
							<tspan x={12.955} y={21}>
						...
						<g transform="translate(37.43 18.465)">
							<g
								className="e-reward-28-mobile"
								transform="translate(3.57 -1)">
								<g className="e-reward-28-mobile">
									<path
										className="f-reward-28-mobile"
									...
									/>
									<g
										className="i-reward-28-mobile"
										transform="translate(3.208 27.847)">
										<g className="j-reward-28-mobile">
											<path
												className="h-reward-28-mobile"
									...
									<g
										...
										<g className="k-reward-28-mobile">
											<path
												className="h-reward-28-mobile"
