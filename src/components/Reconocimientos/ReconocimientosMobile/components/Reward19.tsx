...
const Reward19Mobile: React.FC = (): JSX.Element => {
	/** States */
	const [showCard, setShowCard] = React.useState<boolean>(false)

	return (
		<g
			transform="translate(-23 2069)"
			onClick={() => setShowCard(!showCard)}>
			{!showCard ? (
				<React.Fragment>
					<g
						className="dn-time-line"
						transform="matrix(1, 0, 0, 1, -68.98, -1438.37)">
						<rect
							className="a-time-line"
							width={120}
							height={141}
							rx={8}
							transform="translate(68.98 1438.37)"
						/>
					</g>
					...
					<text className="da-time-line" transform="translate(60 51)">
						<tspan x={-21.708} y={11}>
							{'Stryker'}
						</tspan>
					</text>
