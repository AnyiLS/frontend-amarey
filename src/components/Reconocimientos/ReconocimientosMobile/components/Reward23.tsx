...
const Reward23Mobile: React.FC = (): JSX.Element => {
	/** States */
	const [showCard, setShowCard] = React.useState<boolean>(false)

	return (
		<g
			transform="translate(112 2225)"
			onClick={() => setShowCard(!showCard)}>
			{!showCard ? (
				<React.Fragment>
					<g
						className="ds-time-line"
						transform="matrix(1, 0, 0, 1, -203.98, -1594.37)">
						<rect
							className="a-time-line"
							width={120}
							height={141}
							rx={8}
							transform="translate(203.98 1594.37)"
						/>
					</g>
				...
				<React.Fragment>
					<defs>
						<style>
							{
								'.a-reward-23-mobile{fill:none;}.b-reward-23-mobile{fill:#001f5f;}.c-reward-23-mobile,.d-reward-23-mobile{fill:#fff;}.c-reward-23-mobile{font-size:10px;font-family:Silka-SemiBold, Silka;font-weight:600;}.d-reward-23-mobile{font-size:13px;font-family:Silka-Regular, Silka;}.e-reward-23-mobile{clip-path:url(#c-reward-23-mobile);}.f-reward-23-mobile{fill:#f2f2f2;}.g-reward-23-mobile{fill:#e6e6e6;}.h-reward-23-mobile{fill:#ccc;}.i-reward-23-mobile{opacity:0.4;mix-blend-mode:multiply;isolation:isolate;}.j-reward-23-mobile{clip-path:url(#e-reward-23-mobile);}.k-reward-23-mobile{clip-path:url(#f-reward-23-mobile);}.l-reward-23-mobile{fill:#e7002a;}.m-reward-23-mobile{filter:url(#a-reward-23-mobile);}'
							}
						</style>
						<filter
							id="a-reward-23-mobile"
							x={0}
							y={0}
							width={138}
							height={159}
						...
						<clipPath id="c-reward-23-mobile">
							<rect
								className="a-reward-23-mobile"
								width={38}
								height={33.933}
							/>
						</clipPath>
						<clipPath id="e-reward-23-mobile">
							<rect
								className="a-reward-23-mobile"
								width={31.529}
								height={3.548}
						...
						<clipPath id="f-reward-23-mobile">
							<rect
								className="a-reward-23-mobile"
								width={29.824}
								height={2.479}
					...
					<g>
						<g
							className="m-reward-23-mobile"
							transform="matrix(1, 0, 0, 1, -9, -6)">
							<rect
								className="b-reward-23-mobile"
								width={120}
								height={141}
								rx={8}
						...
						<g transform="translate(37.43 18.067)">
							<g
								className="e-reward-23-mobile"
								transform="translate(3.57 -1)">
								<g className="e-reward-23-mobile">
									<path
										className="f-reward-23-mobile"
									...
									/>
									<g
										className="i-reward-23-mobile"
										transform="translate(3.208 27.847)">
										<g className="j-reward-23-mobile">
											<path
												className="h-reward-23-mobile"
									...
									<g
										...
										<g className="k-reward-23-mobile">
											<path
												className="h-reward-23-mobile"
