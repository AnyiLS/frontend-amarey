...
const Reward16Mobile: React.FC = (): JSX.Element => {
	/** States */
	const [showCard, setShowCard] = React.useState<boolean>(false)

	return (
		<g
			transform="translate(-23 1913)"
			onClick={() => setShowCard(!showCard)}>
			{!showCard ? (
				<React.Fragment>
					<g
						className="eg-time-line"
						transform="matrix(1, 0, 0, 1, -68.98, -1282.37)">
						<rect
							className="a-time-line"
							width={120}
							height={141}
							rx={8}
							transform="translate(68.98 1282.37)"
						/>
					</g>
				...
				<React.Fragment>
					<defs>
						<style>
							{
								'.a-reward-16-mobile{fill:none;}.b-reward-16-mobile{fill:#001f5f;}.c-reward-16-mobile,.d-reward-16-mobile{fill:#fff;font-size:10px;}.c-reward-16-mobile{font-family:Silka-SemiBold, Silka;font-weight:600;}.d-reward-16-mobile{font-family:Silka-Regular, Silka;}.e-reward-16-mobile{clip-path:url(#c-reward-16-mobile);}.f-reward-16-mobile{fill:#f2f2f2;}.g-reward-16-mobile{fill:#e6e6e6;}.h-reward-16-mobile{fill:#ccc;}.i-reward-16-mobile{opacity:0.4;mix-blend-mode:multiply;isolation:isolate;}.j-reward-16-mobile{clip-path:url(#e-reward-16-mobile);}.k-reward-16-mobile{clip-path:url(#f-reward-16-mobile);}.l-reward-16-mobile{fill:#e7002a;}.m-reward-16-mobile{filter:url(#a-reward-16-mobile);}'
							}
						</style>
						<filter
							id="a-reward-16-mobile"
							x={0}
							y={0}
							width={138}
							height={159}
						...
						<clipPath id="c-reward-16-mobile">
							<rect
								className="a-reward-16-mobile"
								width={38}
								height={33.933}
							/>
						</clipPath>
						<clipPath id="e-reward-16-mobile">
							<rect
								className="a-reward-16-mobile"
								width={31.529}
								height={3.548}
						...
						<clipPath id="f-reward-16-mobile">
							<rect
								className="a-reward-16-mobile"
								width={29.824}
								height={2.479}
					...
					<g>
						<g
							className="m-reward-16-mobile"
							transform="matrix(1, 0, 0, 1, -9, -6)">
							<rect
								className="b-reward-16-mobile"
								width={120}
								height={141}
								rx={8}
						...
						<g transform="translate(37.43 15.465)">
							<g
								className="e-reward-16-mobile"
								transform="translate(3.57 -1)">
								<g className="e-reward-16-mobile">
									<path
										className="f-reward-16-mobile"
									...
									/>
									<g
										className="i-reward-16-mobile"
										transform="translate(3.208 27.847)">
										<g className="j-reward-16-mobile">
											<path
												className="h-reward-16-mobile"
									...
									<g
										...
										<g className="k-reward-16-mobile">
											<path
												className="h-reward-16-mobile"
