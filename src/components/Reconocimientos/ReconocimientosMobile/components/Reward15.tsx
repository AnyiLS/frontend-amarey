...
const Reward15Mobile: React.FC = (): JSX.Element => {
	/** States */
	const [showCard, setShowCard] = React.useState<boolean>(false)

	return (
		<g
			transform="translate(248 1757)"
			onClick={() => setShowCard(!showCard)}>
			{!showCard ? (
				<React.Fragment>
					<g
						className="di-time-line"
						transform="matrix(1, 0, 0, 1, -339.98, -1126.37)">
						<rect
							className="a-time-line"
							width={120}
							height={141}
							rx={8}
							transform="translate(339.98 1126.37)"
						/>
					</g>
				...
				<React.Fragment>
					<defs>
						<style>
							{
								'.a-reward-15-mobile{fill:none;}.b-reward-15-mobile{fill:#001f5f;}.c-reward-15-mobile,.d-reward-15-mobile{fill:#fff;font-size:10px;}.c-reward-15-mobile{font-family:Silka-SemiBold, Silka;font-weight:600;}.d-reward-15-mobile{font-family:Silka-Regular, Silka;}.e-reward-15-mobile{clip-path:url(#c-reward-15-mobile);}.f-reward-15-mobile{fill:#f2f2f2;}.g-reward-15-mobile{fill:#e6e6e6;}.h-reward-15-mobile{fill:#ccc;}.i-reward-15-mobile{opacity:0.4;mix-blend-mode:multiply;isolation:isolate;}.j-reward-15-mobile{clip-path:url(#e-reward-15-mobile);}.k-reward-15-mobile{clip-path:url(#f-reward-15-mobile);}.l-reward-15-mobile{fill:#e7002a;}.m-reward-15-mobile{filter:url(#a-reward-15-mobile);}'
							}
						</style>
						<filter
							id="a-reward-15-mobile"
							x={0}
							y={0}
							width={138}
							height={159}
						...
						<clipPath id="c-reward-15-mobile">
							<rect
								className="a-reward-15-mobile"
								width={38}
								height={33.933}
							/>
						</clipPath>
						<clipPath id="e-reward-15-mobile">
							<rect
								className="a-reward-15-mobile"
								width={31.529}
								height={3.548}
						...
						<clipPath id="f-reward-15-mobile">
							<rect
								className="a-reward-15-mobile"
								width={29.824}
								height={2.479}
					...
					<g>
						<g
							className="m-reward-15-mobile"
							transform="matrix(1, 0, 0, 1, -9, -6)">
							<rect
								className="b-reward-15-mobile"
								width={120}
								height={141}
								rx={8}
						...
						<text
							className="d-reward-15-mobile"
							transform="translate(12 78.5)">
							<tspan x={11.42} y={9}>
								{'Most innovative '}
							</tspan>
							<tspan x={19.335} y={21}>
						...
						<g transform="translate(37.43 12.567)">
							<g
								className="e-reward-15-mobile"
								transform="translate(3.57 -1)">
								<g className="e-reward-15-mobile">
									<path
										className="f-reward-15-mobile"
									...
									/>
									<g
										className="i-reward-15-mobile"
										transform="translate(3.208 27.847)">
										<g className="j-reward-15-mobile">
											<path
												className="h-reward-15-mobile"
									...
									<g
										...
										<g className="k-reward-15-mobile">
											<path
												className="h-reward-15-mobile"
