...
const Reward20Mobile: React.FC = (): JSX.Element => {
	/** States */
	const [showCard, setShowCard] = React.useState<boolean>(false)

	return (
		<g
			transform="translate(111 2069)"
			onClick={() => setShowCard(!showCard)}>
			{!showCard ? (
				<React.Fragment>
					<g
						className="dh-time-line"
						transform="matrix(1, 0, 0, 1, -202.98, -1438.37)">
						<rect
							className="a-time-line"
							width={120}
							height={141}
							rx={8}
							transform="translate(202.98 1438.37)"
						/>
					</g>
				...
				<React.Fragment>
					<defs>
						<style>
							{
								'.a-reward-20-mobile{fill:none;}.b-reward-20-mobile{fill:#001f5f;}.c-reward-20-mobile,.d-reward-20-mobile{fill:#fff;}.c-reward-20-mobile{font-size:10px;font-family:Silka-SemiBold, Silka;font-weight:600;}.d-reward-20-mobile{font-size:8px;font-family:Silka-Regular, Silka;}.e-reward-20-mobile{clip-path:url(#c-reward-20-mobile);}.f-reward-20-mobile{fill:#f2f2f2;}.g-reward-20-mobile{fill:#e6e6e6;}.h-reward-20-mobile{fill:#ccc;}.i-reward-20-mobile{opacity:0.4;mix-blend-mode:multiply;isolation:isolate;}.j-reward-20-mobile{clip-path:url(#e-reward-20-mobile);}.k-reward-20-mobile{clip-path:url(#f-reward-20-mobile);}.l-reward-20-mobile{fill:#e7002a;}.m-reward-20-mobile{filter:url(#a-reward-20-mobile);}'
							}
						</style>
						<filter
							id="a-reward-20-mobile"
							x={0}
							y={0}
							width={138}
							height={159}
						...
						<clipPath id="c-reward-20-mobile">
							<rect
								className="a-reward-20-mobile"
								width={38}
								height={33.933}
							/>
						</clipPath>
						<clipPath id="e-reward-20-mobile">
							<rect
								className="a-reward-20-mobile"
								width={31.529}
								height={3.548}
						...
						<clipPath id="f-reward-20-mobile">
							<rect
								className="a-reward-20-mobile"
								width={29.824}
								height={2.479}
					...
					<g>
						<g
							className="m-reward-20-mobile"
							transform="matrix(1, 0, 0, 1, -9, -6)">
							<rect
								className="b-reward-20-mobile"
								width={120}
								height={141}
								rx={8}
						...
						<text
							className="d-reward-20-mobile"
							transform="translate(12.5 83)">
							<tspan x={1.732} y={8}>
								{'35 años contribuyendo '}
							</tspan>
							<tspan x={0.752} y={18}>
								{'a mejorar la sanidad en '}
							</tspan>
							<tspan x={28.464} y={28}>
								{'Colombia'}
							</tspan>
						...
						<g transform="translate(37.43 12.465)">
							<g
								className="e-reward-20-mobile"
								transform="translate(3.57 -1)">
								<g className="e-reward-20-mobile">
									<path
										className="f-reward-20-mobile"
									...
									/>
									<g
										className="i-reward-20-mobile"
										transform="translate(3.208 27.847)">
										<g className="j-reward-20-mobile">
											<path
												className="h-reward-20-mobile"
									...
									<g
										...
										<g className="k-reward-20-mobile">
											<path
												className="h-reward-20-mobile"
