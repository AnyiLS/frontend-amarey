...
const Reward30Mobile: React.FC = (): JSX.Element => {
	/** States */
	const [showCard, setShowCard] = React.useState<boolean>(false)

	return (
		<g
			transform="translate(248 2537)"
			onClick={() => setShowCard(!showCard)}>
			{!showCard ? (
				<React.Fragment>
					<g
						className="df-time-line"
						transform="matrix(1, 0, 0, 1, -339.98, -1906.37)">
						<rect
							className="a-time-line"
							width={120}
							height={141}
							rx={8}
							transform="translate(339.98 1906.37)"
						/>
					</g>
				...
				<React.Fragment>
					<defs>
						<style>
							{
								'.a-reward-30-mobile{fill:none;}.b-reward-30-mobile{fill:#001f5f;}.c-reward-30-mobile,.d-reward-30-mobile{fill:#fff;font-size:10px;}.c-reward-30-mobile{font-family:Silka-SemiBold, Silka;font-weight:600;}.d-reward-30-mobile{font-family:Silka-Regular, Silka;}.e-reward-30-mobile{clip-path:url(#c-reward-30-mobile);}.f-reward-30-mobile{fill:#f2f2f2;}.g-reward-30-mobile{fill:#e6e6e6;}.h-reward-30-mobile{fill:#ccc;}.i-reward-30-mobile{opacity:0.4;mix-blend-mode:multiply;isolation:isolate;}.j-reward-30-mobile{clip-path:url(#e-reward-30-mobile);}.k-reward-30-mobile{clip-path:url(#f-reward-30-mobile);}.l-reward-30-mobile{fill:#e7002a;}.m-reward-30-mobile{filter:url(#a-reward-30-mobile);}'
							}
						</style>
						<filter
							id="a-reward-30-mobile"
							x={0}
							y={0}
							width={138}
							height={159}
						...
						<clipPath id="c-reward-30-mobile">
							<rect
								className="a-reward-30-mobile"
								width={38}
								height={33.933}
							/>
						</clipPath>
						<clipPath id="e-reward-30-mobile">
							<rect
								className="a-reward-30-mobile"
								width={31.529}
								height={3.548}
						...
						<clipPath id="f-reward-30-mobile">
							<rect
								className="a-reward-30-mobile"
								width={29.824}
								height={2.479}
					...
					<g>
						<g
							className="m-reward-30-mobile"
							transform="matrix(1, 0, 0, 1, -9, -6)">
							<rect
								className="b-reward-30-mobile"
								width={120}
								height={141}
								rx={8}
						...
						<text
							className="c-reward-30-mobile"
							transform="translate(60 59.204)">
							<tspan x={-18.09} y={9}>
								{'Stryker '}
							</tspan>
						</text>
						...
						<text
							className="d-reward-30-mobile"
							transform="translate(9.5 83.602)">
							<tspan x={3.65} y={9}>
								{'Tops Sales Trauma, '}
							</tspan>
							<tspan x={11.635} y={21}>
						...
						<g transform="translate(37.43 15.465)">
							<g
								className="e-reward-30-mobile"
								transform="translate(3.57 -1)">
								<g className="e-reward-30-mobile">
									<path
										className="f-reward-30-mobile"
									...
									/>
									<g
										className="i-reward-30-mobile"
										transform="translate(3.208 27.847)">
										<g className="j-reward-30-mobile">
											<path
												className="h-reward-30-mobile"
									...
									<g
										...
										<g className="k-reward-30-mobile">
											<path
												className="h-reward-30-mobile"
