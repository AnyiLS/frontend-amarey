...
const Reward12Mobile: React.FC = (): JSX.Element => {
	/** States */
	const [showCard, setShowCard] = React.useState<boolean>(false)

	return (
		<g
			transform="translate(247 1601)"
			onClick={() => setShowCard(!showCard)}>
			{!showCard ? (
				<React.Fragment>
					<g
						className="ea-time-line"
						transform="matrix(1, 0, 0, 1, -338.98, -970.37)">
						<rect
							className="a-time-line"
							width={120}
							height={141}
							rx={8}
							transform="translate(338.98 970.37)"
						/>
					</g>
				...
				<React.Fragment>
					<defs>
						<style>
							{
								'.a-reward-12-mobile{fill:none;}.b-reward-12-mobile{fill:#001f5f;}.c-reward-12-mobile,.d-reward-12-mobile{fill:#fff;font-size:10px;}.c-reward-12-mobile{font-family:Silka-SemiBold, Silka;font-weight:600;}.d-reward-12-mobile{font-family:Silka-Regular, Silka;}.e-reward-12-mobile{clip-path:url(#c-reward-12-mobile);}.f-reward-12-mobile{fill:#f2f2f2;}.g-reward-12-mobile{fill:#e6e6e6;}.h-reward-12-mobile{fill:#ccc;}.i-reward-12-mobile{opacity:0.4;mix-blend-mode:multiply;isolation:isolate;}.j-reward-12-mobile{clip-path:url(#e-reward-12-mobile);}.k-reward-12-mobile{clip-path:url(#f-reward-12-mobile);}.l-reward-12-mobile{fill:#e7002a;}.m-reward-12-mobile{filter:url(#a-reward-12-mobile);}'
							}
						</style>
						<filter
							id="a-reward-12-mobile"
							x={0}
							y={0}
							width={138}
							height={159}
						...
						<clipPath id="c-reward-12-mobile">
							<rect
								className="a-reward-12-mobile"
								width={38}
								height={33.933}
							/>
						</clipPath>
						<clipPath id="e-reward-12-mobile">
							<rect
								className="a-reward-12-mobile"
								width={31.529}
								height={3.548}
						...
						<clipPath id="f-reward-12-mobile">
							<rect
								className="a-reward-12-mobile"
								width={29.824}
								height={2.479}
					...
					<g>
						<g
							className="m-reward-12-mobile"
							transform="matrix(1, 0, 0, 1, -9, -6)">
							<rect
								className="b-reward-12-mobile"
								width={120}
								height={141}
								rx={8}
						...
						<text
							className="d-reward-12-mobile"
							transform="translate(9.5 82)">
							<tspan x={4.1} y={9}>
								{'Global distribution '}
							</tspan>
							<tspan x={7.35} y={21}>
						...
						<g transform="translate(37.43 15.465)">
							<g
								className="e-reward-12-mobile"
								transform="translate(3.57 -1)">
								<g className="e-reward-12-mobile">
									<path
										className="f-reward-12-mobile"
									...
									/>
									<g
										className="i-reward-12-mobile"
										transform="translate(3.208 27.847)">
										<g className="j-reward-12-mobile">
											<path
												className="h-reward-12-mobile"
									...
									<g
										...
										<g className="k-reward-12-mobile">
											<path
												className="h-reward-12-mobile"
