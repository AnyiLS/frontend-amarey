...
const Reward13Mobile: React.FC = (): JSX.Element => {
	/** States */
	const [showCard, setShowCard] = React.useState<boolean>(false)

	return (
		<g
			transform="translate(-24 1757)"
			onClick={() => setShowCard(!showCard)}>
			{!showCard ? (
				<React.Fragment>
					<g
						className="du-time-line"
						transform="matrix(1, 0, 0, 1, -67.98, -1126.37)">
						<rect
							className="a-time-line"
							width={120}
							height={141}
							rx={8}
							transform="translate(67.98 1126.37)"
						/>
					</g>
				...
				<React.Fragment>
					<defs>
						<style>
							{
								'.a-reward-13-mobile{fill:none;}.b-reward-13-mobile{fill:#001f5f;}.c-reward-13-mobile,.d-reward-13-mobile{fill:#fff;font-size:10px;}.c-reward-13-mobile{font-family:Silka-SemiBold, Silka;font-weight:600;}.d-reward-13-mobile{font-family:Silka-Regular, Silka;}.e-reward-13-mobile{clip-path:url(#c-reward-13-mobile);}.f-reward-13-mobile{fill:#f2f2f2;}.g-reward-13-mobile{fill:#e6e6e6;}.h-reward-13-mobile{fill:#ccc;}.i-reward-13-mobile{opacity:0.4;mix-blend-mode:multiply;isolation:isolate;}.j-reward-13-mobile{clip-path:url(#e-reward-13-mobile);}.k-reward-13-mobile{clip-path:url(#f-reward-13-mobile);}.l-reward-13-mobile{fill:#e7002a;}.m-reward-13-mobile{filter:url(#a-reward-13-mobile);}'
							}
						</style>
						<filter
							id="a-reward-13-mobile"
							x={0}
							y={0}
							width={138}
							height={159}
						...
						<clipPath id="c-reward-13-mobile">
							<rect
								className="a-reward-13-mobile"
								width={38}
								height={33.933}
							/>
						</clipPath>
						<clipPath id="e-reward-13-mobile">
							<rect
								className="a-reward-13-mobile"
								width={31.529}
								height={3.548}
						...
						<clipPath id="f-reward-13-mobile">
							<rect
								className="a-reward-13-mobile"
								width={29.824}
								height={2.479}
					...
					<g>
						<g
							className="m-reward-13-mobile"
							transform="matrix(1, 0, 0, 1, -9, -6)">
							<rect
								className="b-reward-13-mobile"
								width={120}
								height={141}
								rx={8}
						...
						<g transform="translate(36.93 12.465)">
							<g
								className="e-reward-13-mobile"
								transform="translate(3.57 -1)">
								<g className="e-reward-13-mobile">
									<path
										className="f-reward-13-mobile"
									...
									/>
									<g
										className="i-reward-13-mobile"
										transform="translate(3.208 27.847)">
										<g className="j-reward-13-mobile">
											<path
												className="h-reward-13-mobile"
									...
									<g
										...
										<g className="k-reward-13-mobile">
											<path
												className="h-reward-13-mobile"
