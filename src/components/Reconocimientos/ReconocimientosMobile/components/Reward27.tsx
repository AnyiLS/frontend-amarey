...
const Reward27Mobile: React.FC = (): JSX.Element => {
	/** States */
	const [showCard, setShowCard] = React.useState<boolean>(false)

	return (
		<g
			transform="translate(248 2381)"
			onClick={() => setShowCard(!showCard)}>
			{!showCard ? (
				<React.Fragment>
					<g
						className="dx-time-line"
						transform="matrix(1, 0, 0, 1, -339.98, -1750.37)">
						<rect
							className="a-time-line"
							width={120}
							height={141}
							rx={8}
							transform="translate(339.98 1750.37)"
						/>
					</g>
					...
					<text className="da-time-line" transform="translate(60 52)">
						<tspan x={-18.408} y={11}>
							{'Chiesi'}
						</tspan>
					</text>
      ...
      <style>
        {
          ".a-reward-27-mobile{fill:none;}.b-reward-27-mobile{fill:#001f5f;}.c-reward-27-mobile,.d-reward-27-mobile{fill:#fff;font-size:10px;}.c-reward-27-mobile{font-family:Silka-SemiBold, Silka;font-weight:600;}.d-reward-27-mobile{font-family:Silka-Regular, Silka;}.e-reward-27-mobile{clip-path:url(#c-reward-27-mobile);}.f-reward-27-mobile{fill:#f2f2f2;}.g-reward-27-mobile{fill:#e6e6e6;}.h-reward-27-mobile{fill:#ccc;}.i-reward-27-mobile{opacity:0.4;mix-blend-mode:multiply;isolation:isolate;}.j-reward-27-mobile{clip-path:url(#e-reward-27-mobile);}.k-reward-27-mobile{clip-path:url(#f-reward-27-mobile);}.l-reward-27-mobile{fill:#e7002a;}.m-reward-27-mobile{filter:url(#a-reward-27-mobile);}"
        }
      </style>
      <filter
        id="a-reward-27-mobile"
        x={0}
        y={0}
        width={138}
        height={159}
      ...
      <clipPath id="c-reward-27-mobile">
        <rect className="a-reward-27-mobile" width={38} height={33.933} />
      </clipPath>
      <clipPath id="e-reward-27-mobile">
        <rect className="a-reward-27-mobile" width={31.529} height={3.548} />
      </clipPath>
      <clipPath id="f-reward-27-mobile">
        <rect className="a-reward-27-mobile" width={29.824} height={2.479} />
      </clipPath>
    </defs>
    <g>
      <g className="m-reward-27-mobile" transform="matrix(1, 0, 0, 1, -9, -6)">
        <rect
          className="b-reward-27-mobile"
          width={120}
          height={141}
          rx={8}
      ...
      <text className="c-reward-27-mobile" transform="translate(60 57)">
        <tspan x={-15.34} y={9}>
          {"Chiesi"}
        </tspan>
      </text>
      <text className="c-reward-27-mobile" transform="translate(60 124)">
        <tspan x={-22.89} y={9}>
          {"Año 2022"}
        </tspan>
      </text>
      <text className="d-reward-27-mobile" transform="translate(15.5 83)">
        <tspan x={12.685} y={9}>
          {"Neonatology "}
        </tspan>
        <tspan x={4.825} y={21}>
      ...
      <g transform="translate(37.43 12.465)">
        <g className="e-reward-27-mobile" transform="translate(3.57 -1)">
          <g className="e-reward-27-mobile">
            <path
              className="f-reward-27-mobile"
            ...
            />
            <g className="i-reward-27-mobile" transform="translate(3.208 27.847)">
              <g className="j-reward-27-mobile">
                <path
                  className="h-reward-27-mobile"
            ...
            />
            <g className="i-reward-27-mobile" transform="translate(4.061 22.829)">
              <g className="k-reward-27-mobile">
                <path
                  className="h-reward-27-mobile"
