...
const Reward8Mobile: React.FC = (): JSX.Element => {
	/** States */
	const [showCard, setShowCard] = React.useState<boolean>(false)

	return (
		<g
			transform="translate(111 1445)"
			onClick={() => setShowCard(!showCard)}>
			{!showCard ? (
				<React.Fragment>
					<g
						className="dv-time-line"
						transform="matrix(1, 0, 0, 1, -202.98, -814.37)">
						<rect
							className="a-time-line"
							width={120}
							height={141}
							rx={8}
							transform="translate(202.98 814.37)"
						/>
					</g>
				...
				<React.Fragment>
					<defs>
						<style>
							{
								'.a-reward-8-mobile{fill:none;}.b-reward-8-mobile{fill:#001f5f;}.c-reward-8-mobile,.d-reward-8-mobile{fill:#fff;}.c-reward-8-mobile{font-size:10px;font-family:Silka-SemiBold, Silka;font-weight:600;}.d-reward-8-mobile{font-size:8px;font-family:Silka-Regular, Silka;}.e-reward-8-mobile{clip-path:url(#c-reward-8-mobile);}.f-reward-8-mobile{fill:#f2f2f2;}.g-reward-8-mobile{fill:#e6e6e6;}.h-reward-8-mobile{fill:#ccc;}.i-reward-8-mobile{opacity:0.4;mix-blend-mode:multiply;isolation:isolate;}.j-reward-8-mobile{clip-path:url(#e-reward-8-mobile);}.k-reward-8-mobile{clip-path:url(#f-reward-8-mobile);}.l-reward-8-mobile{fill:#e7002a;}.m-reward-8-mobile{filter:url(#a-reward-8-mobile);}'
							}
						</style>
						<filter
							id="a-reward-8-mobile"
							x={0}
							y={0}
							width={138}
							height={159}
						...
						<clipPath id="c-reward-8-mobile">
							<rect
								className="a-reward-8-mobile"
								width={38}
								height={33.933}
							/>
						</clipPath>
						<clipPath id="e-reward-8-mobile">
							<rect
								className="a-reward-8-mobile"
								width={31.529}
								height={3.548}
					...
					<g>
						<g
							className="m-reward-8-mobile"
							transform="matrix(1, 0, 0, 1, -9, -6)">
							<rect
								className="b-reward-8-mobile"
								width={120}
								height={141}
								rx={8}
						...
						<text
							className="c-reward-8-mobile"
							transform="translate(60 56.465)">
							<tspan x={-33.865} y={9}>
								{'Nihon Kohden'}
							</tspan>
						</text>
						...
						<text
							className="d-reward-8-mobile"
							transform="translate(9.5 82.5)">
							<tspan x={22.584} y={8}>
								{'2014 Top sales '}
							</tspan>
							<tspan x={11.272} y={18}>
						...
						<g transform="translate(37.43 14.465)">
							<g
								className="e-reward-8-mobile"
								transform="translate(3.57 -1)">
								<g className="e-reward-8-mobile">
									<path
										className="f-reward-8-mobile"
									...
									/>
									<g
										className="i-reward-8-mobile"
										transform="translate(3.208 27.847)">
										<g className="j-reward-8-mobile">
											<path
												className="h-reward-8-mobile"
