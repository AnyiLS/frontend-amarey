...
const Reward29Mobile: React.FC = (): JSX.Element => {
	/** States */
	const [showCard, setShowCard] = React.useState<boolean>(false)

	return (
		<g
			transform="translate(112 2537)"
			onClick={() => setShowCard(!showCard)}>
			{!showCard ? (
				<React.Fragment>
					<g
						className="dl-time-line"
						transform="matrix(1, 0, 0, 1, -203.98, -1906.37)">
						<rect
							className="a-time-line"
							width={120}
							height={141}
							rx={8}
							transform="translate(203.98 1906.37)"
						/>
					</g>
				...
				<React.Fragment>
					<defs>
						<style>
							{
								'.a-reward-29-mobile{fill:none;}.b-reward-29-mobile{fill:#001f5f;}.c-reward-29-mobile,.d-reward-29-mobile{fill:#fff;font-size:10px;}.c-reward-29-mobile{font-family:Silka-SemiBold, Silka;font-weight:600;}.d-reward-29-mobile{font-family:Silka-Regular, Silka;}.e-reward-29-mobile{clip-path:url(#c-reward-29-mobile);}.f-reward-29-mobile{fill:#f2f2f2;}.g-reward-29-mobile{fill:#e6e6e6;}.h-reward-29-mobile{fill:#ccc;}.i-reward-29-mobile{opacity:0.4;mix-blend-mode:multiply;isolation:isolate;}.j-reward-29-mobile{clip-path:url(#e-reward-29-mobile);}.k-reward-29-mobile{clip-path:url(#f-reward-29-mobile);}.l-reward-29-mobile{fill:#e7002a;}.m-reward-29-mobile{filter:url(#a-reward-29-mobile);}'
							}
						</style>
						<filter
							id="a-reward-29-mobile"
							x={0}
							y={0}
							width={138}
							height={159}
						...
						<clipPath id="c-reward-29-mobile">
							<rect
								className="a-reward-29-mobile"
								width={38}
								height={33.933}
							/>
						</clipPath>
						<clipPath id="e-reward-29-mobile">
							<rect
								className="a-reward-29-mobile"
								width={31.529}
								height={3.548}
						...
						<clipPath id="f-reward-29-mobile">
							<rect
								className="a-reward-29-mobile"
								width={29.824}
								height={2.479}
					...
					<g>
						<g
							className="m-reward-29-mobile"
							transform="matrix(1, 0, 0, 1, -9, -6)">
							<rect
								className="b-reward-29-mobile"
								width={120}
								height={141}
								rx={8}
						...
						<text
							className="c-reward-29-mobile"
							transform="translate(60 52.398)">
							<tspan x={-15.34} y={9}>
								{'Chiesi'}
							</tspan>
						</text>
						...
						<text
							className="d-reward-29-mobile"
							transform="translate(15.5 68.398)">
							<tspan x={18.715} y={9}>
								{'Long-term '}
							</tspan>
							<tspan x={15.96} y={21}>
						...
						<g transform="translate(37.43 14.465)">
							<g
								className="e-reward-29-mobile"
								transform="translate(3.57 -1)">
								<g className="e-reward-29-mobile">
									<path
										className="f-reward-29-mobile"
									...
									/>
									<g
										className="i-reward-29-mobile"
										transform="translate(3.208 27.847)">
										<g className="j-reward-29-mobile">
											<path
												className="h-reward-29-mobile"
									...
									<g
										...
										<g className="k-reward-29-mobile">
											<path
												className="h-reward-29-mobile"
