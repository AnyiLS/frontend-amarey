...
const Reward3Mobile: React.FC = (): JSX.Element => {
	...
	return (
		<g transform="translate(247 1133)" onClick={() => setShowCard(!showCard)}>
			{!showCard ? (
				<React.Fragment>
					<g
						className="dw-time-line"
						transform="matrix(1, 0, 0, 1, -338.98, -502.37)">
						<rect
							className="a-time-line"
							width={120}
							height={141}
							rx={8}
							transform="translate(338.98 502.37)"
						/>
					</g>
				...
				<React.Fragment>
					<defs>
						<style>
							{
								'.a-reward-3-mobile{fill:none;}.b-reward-3-mobile{fill:#001f5f;}.c-reward-3-mobile,.d-reward-3-mobile{fill:#fff;}.c-reward-3-mobile{font-size:10px;font-family:Silka-SemiBold, Silka;font-weight:600;}.d-reward-3-mobile{font-size:8px;font-family:Silka-Regular, Silka;}.e-reward-3-mobile{clip-path:url(#c-reward-3-mobile);}.f-reward-3-mobile{fill:#f2f2f2;}.g-reward-3-mobile{fill:#e6e6e6;}.h-reward-3-mobile{fill:#ccc;}.i-reward-3-mobile{opacity:0.4;mix-blend-mode:multiply;isolation:isolate;}.j-reward-3-mobile{clip-path:url(#e-reward-3-mobile);}.k-reward-3-mobile{clip-path:url(#f-reward-3-mobile);}.l-reward-3-mobile{fill:#e7002a;}.m-reward-3-mobile{filter:url(#a-reward-3-mobile);}'
							}
						</style>
						<filter
							id="a-reward-3-mobile"
							x={0}
							y={0}
							width={138}
							height={159}
						...
						<clipPath id="c-reward-3-mobile">
							<rect
								className="a-reward-3-mobile"
								width={38}
								height={33.933}
							/>
						</clipPath>
						<clipPath id="e-reward-3-mobile">
							<rect
								className="a-reward-3-mobile"
								width={31.529}
								height={3.548}
					...
					<g>
						<g
							className="m-reward-3-mobile"
							transform="matrix(1, 0, 0, 1, -9, -6)">
							<rect
								className="b-reward-3-mobile"
								width={120}
								height={141}
								rx={8}
						...
						<text
							className="c-reward-3-mobile"
							transform="translate(60.5 54)">
							<tspan x={-21.085} y={9}>
								{'Hospital '}
							</tspan>
							<tspan x={-36.29} y={21}>
						...
						<g transform="translate(37.43 12.567)">
							<g
								className="e-reward-3-mobile"
								transform="translate(3.57 -1)">
								<g className="e-reward-3-mobile">
									<path
										className="f-reward-3-mobile"
									...
									/>
									<g
										className="i-reward-3-mobile"
										transform="translate(3.208 27.847)">
										<g className="j-reward-3-mobile">
											<path
												className="h-reward-3-mobile"
