...
const Reward6Mobile: React.FC = (): JSX.Element => {
	/** States */
	const [showCard, setShowCard] = React.useState<boolean>(false)

	return (
		<g
			transform="translate(247 1289)"
			onClick={() => setShowCard(!showCard)}>
			{!showCard ? (
				<React.Fragment>
					<g
						className="ei-time-line"
						transform="matrix(1, 0, 0, 1, -338.98, -658.37)">
						<rect
							className="a-time-line"
							width={120}
							height={141}
							rx={8}
							transform="translate(338.98 658.37)"
						/>
					</g>
				...
				<React.Fragment>
					<defs>
						<style>
							{
								'.a-reward-6-mobile{fill:none;}.b-reward-6-mobile{fill:#001f5f;}.c-reward-6-mobile,.d-reward-6-mobile{fill:#fff;font-size:10px;}.c-reward-6-mobile{font-family:Silka-SemiBold, Silka;font-weight:600;}.d-reward-6-mobile{font-family:Silka-Regular, Silka;}.e-reward-6-mobile{clip-path:url(#c-reward-6-mobile);}.f-reward-6-mobile{fill:#f2f2f2;}.g-reward-6-mobile{fill:#e6e6e6;}.h-reward-6-mobile{fill:#ccc;}.i-reward-6-mobile{opacity:0.4;mix-blend-mode:multiply;isolation:isolate;}.j-reward-6-mobile{clip-path:url(#e-reward-6-mobile);}.k-reward-6-mobile{clip-path:url(#f-reward-6-mobile);}.l-reward-6-mobile{fill:#e7002a;}.m-reward-6-mobile{filter:url(#a-reward-6-mobile);}'
							}
						</style>
						<filter
							id="a-reward-6-mobile"
							x={0}
							y={0}
							width={138}
							height={159}
						...
						<clipPath id="c-reward-6-mobile">
							<rect
								className="a-reward-6-mobile"
								width={38}
								height={33.933}
							/>
						</clipPath>
						<clipPath id="e-reward-6-mobile">
							<rect
								className="a-reward-6-mobile"
								width={31.529}
								height={3.548}
					...
					<g>
						<g
							className="m-reward-6-mobile"
							transform="matrix(1, 0, 0, 1, -9, -6)">
							<rect
								className="b-reward-6-mobile"
								width={120}
								height={141}
								rx={8}
						...
						<text
							className="d-reward-6-mobile"
							transform="translate(9.5 88.602)">
							<tspan x={3.81} y={9}>
								{'da Vinci procedure '}
							</tspan>
							<tspan x={14.815} y={21}>
						...
						<g transform="translate(37.43 16.465)">
							<g
								className="e-reward-6-mobile"
								transform="translate(3.57 -1)">
								<g className="e-reward-6-mobile">
									<path
										className="f-reward-6-mobile"
									...
									/>
									<g
										className="i-reward-6-mobile"
										transform="translate(3.208 27.847)">
										<g className="j-reward-6-mobile">
											<path
												className="h-reward-6-mobile"
