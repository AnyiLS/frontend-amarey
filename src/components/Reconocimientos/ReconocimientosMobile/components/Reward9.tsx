...
const Reward9Mobile: React.FC = (): JSX.Element => {
	/** States */
	const [showCard, setShowCard] = React.useState<boolean>(false)

	return (
		<g
			transform="translate(247 1445)"
			onClick={() => setShowCard(!showCard)}>
			{!showCard ? (
				<React.Fragment>
					<g
						className="dp-time-line"
						transform="matrix(1, 0, 0, 1, -338.98, -814.37)">
						<rect
							className="a-time-line"
							width={120}
							height={141}
							rx={8}
							transform="translate(338.98 814.37)"
						/>
					</g>
				...
				<React.Fragment>
					<defs>
						<style>
							{
								'.a-reward-9-mobile{fill:none;}.b-reward-9-mobile{fill:#001f5f;}.c-reward-9-mobile,.d-reward-9-mobile{fill:#fff;font-size:10px;}.c-reward-9-mobile{font-family:Silka-SemiBold, Silka;font-weight:600;}.d-reward-9-mobile{font-family:Silka-Regular, Silka;}.e-reward-9-mobile{clip-path:url(#c-reward-9-mobile);}.f-reward-9-mobile{fill:#f2f2f2;}.g-reward-9-mobile{fill:#e6e6e6;}.h-reward-9-mobile{fill:#ccc;}.i-reward-9-mobile{opacity:0.4;mix-blend-mode:multiply;isolation:isolate;}.j-reward-9-mobile{clip-path:url(#e-reward-9-mobile);}.k-reward-9-mobile{clip-path:url(#f-reward-9-mobile);}.l-reward-9-mobile{fill:#e7002a;}.m-reward-9-mobile{filter:url(#a-reward-9-mobile);}'
							}
						</style>
						<filter
							id="a-reward-9-mobile"
							x={0}
							y={0}
							width={138}
							height={159}
						...
						<clipPath id="c-reward-9-mobile">
							<rect
								className="a-reward-9-mobile"
								width={38}
								height={33.933}
							/>
						</clipPath>
						<clipPath id="e-reward-9-mobile">
							<rect
								className="a-reward-9-mobile"
								width={31.529}
								height={3.548}
					...
					<g>
						<g
							className="m-reward-9-mobile"
							transform="matrix(1, 0, 0, 1, -9, -6)">
							<rect
								className="b-reward-9-mobile"
								width={120}
								height={141}
								rx={8}
						...
						<text
							className="d-reward-9-mobile"
							transform="translate(13.5 84.5)">
							<tspan x={5} y={9}>
								{'2014 Extraordinary '}
							</tspan>
							<tspan x={2.505} y={21}>
						...
						<g transform="translate(37.43 15.465)">
							<g
								className="e-reward-9-mobile"
								transform="translate(3.57 -1)">
								<g className="e-reward-9-mobile">
									<path
										className="f-reward-9-mobile"
									...
									/>
									<g
										className="i-reward-9-mobile"
										transform="translate(3.208 27.847)">
										<g className="j-reward-9-mobile">
											<path
												className="h-reward-9-mobile"
