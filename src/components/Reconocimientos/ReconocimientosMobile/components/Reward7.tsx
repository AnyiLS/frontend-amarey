...
const Reward7Mobile: React.FC = (): JSX.Element => {
	/** States */
	const [showCard, setShowCard] = React.useState<boolean>(false)

	return (
		<g
			transform="translate(-25 1445)"
			onClick={() => setShowCard(!showCard)}>
			{!showCard ? (
				<React.Fragment>
					<g
						className="eb-time-line"
						transform="matrix(1, 0, 0, 1, -66.98, -814.37)">
						<rect
							className="a-time-line"
							width={120}
							height={141}
							rx={8}
							transform="translate(66.98 814.37)"
						/>
					</g>
				...
				<React.Fragment>
					<defs>
						<style>
							{
								'.a-reward-7-mobile{fill:none;}.b-reward-7-mobile{fill:#001f5f;}.c-reward-7-mobile,.d-reward-7-mobile{fill:#fff;}.c-reward-7-mobile{font-size:10px;font-family:Silka-SemiBold, Silka;font-weight:600;}.d-reward-7-mobile{font-size:8px;font-family:Silka-Regular, Silka;}.e-reward-7-mobile{clip-path:url(#c-reward-7-mobile);}.f-reward-7-mobile{fill:#f2f2f2;}.g-reward-7-mobile{fill:#e6e6e6;}.h-reward-7-mobile{fill:#ccc;}.i-reward-7-mobile{opacity:0.4;mix-blend-mode:multiply;isolation:isolate;}.j-reward-7-mobile{clip-path:url(#e-reward-7-mobile);}.k-reward-7-mobile{clip-path:url(#f-reward-7-mobile);}.l-reward-7-mobile{fill:#e7002a;}.m-reward-7-mobile{filter:url(#a-reward-7-mobile);}'
							}
						</style>
						<filter
							id="a-reward-7-mobile"
							x={0}
							y={0}
							width={138}
							height={159}
						...
						<clipPath id="c-reward-7-mobile">
							<rect
								className="a-reward-7-mobile"
								width={38}
								height={33.933}
							/>
						</clipPath>
						<clipPath id="e-reward-7-mobile">
							<rect
								className="a-reward-7-mobile"
								width={31.529}
								height={3.548}
					...
					<g>
						<g
							className="m-reward-7-mobile"
							transform="matrix(1, 0, 0, 1, -9, -6)">
							<rect
								className="b-reward-7-mobile"
								width={120}
								height={141}
								rx={8}
						...
						<g transform="translate(37.43 16.465)">
							<g
								className="e-reward-7-mobile"
								transform="translate(3.57 -1)">
								<g className="e-reward-7-mobile">
									<path
										className="f-reward-7-mobile"
									...
									/>
									<g
										className="i-reward-7-mobile"
										transform="translate(3.208 27.847)">
										<g className="j-reward-7-mobile">
											<path
												className="h-reward-7-mobile"
