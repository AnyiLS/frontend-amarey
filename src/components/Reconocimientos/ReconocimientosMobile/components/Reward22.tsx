...
const Reward22Mobile: React.FC = (): JSX.Element => {
	/** States */
	const [showCard, setShowCard] = React.useState<boolean>(false)

	return (
		<g
			transform="translate(-24 2225)"
			onClick={() => setShowCard(!showCard)}>
			{!showCard ? (
				<React.Fragment>
					<g
						className="dy-time-line"
						transform="matrix(1, 0, 0, 1, -67.98, -1594.37)">
						<rect
							className="a-time-line"
							width={120}
							height={141}
							rx={8}
							transform="translate(67.98 1594.37)"
						/>
					</g>
					...
					<text className="dc-time-line" transform="translate(60 45)">
						<tspan x={-25.805} y={9}>
							{'Fundación '}
						</tspan>
						<tspan x={-29.135} y={21}>
				...
				<React.Fragment>
					<defs>
						<style>
							{
								'.a-reward-22-mobile{fill:none;}.b-reward-22-mobile{fill:#001f5f;}.c-reward-22-mobile,.d-reward-22-mobile{fill:#fff;}.c-reward-22-mobile{font-size:10px;font-family:Silka-SemiBold, Silka;font-weight:600;}.d-reward-22-mobile{font-size:8px;font-family:Silka-Regular, Silka;}.e-reward-22-mobile{clip-path:url(#c-reward-22-mobile);}.f-reward-22-mobile{fill:#f2f2f2;}.g-reward-22-mobile{fill:#e6e6e6;}.h-reward-22-mobile{fill:#ccc;}.i-reward-22-mobile{opacity:0.4;mix-blend-mode:multiply;isolation:isolate;}.j-reward-22-mobile{clip-path:url(#e-reward-22-mobile);}.k-reward-22-mobile{clip-path:url(#f-reward-22-mobile);}.l-reward-22-mobile{fill:#e7002a;}.m-reward-22-mobile{filter:url(#a-reward-22-mobile);}'
							}
						</style>
						<filter
							id="a-reward-22-mobile"
							x={0}
							y={0}
							width={138}
							height={159}
						...
						<clipPath id="c-reward-22-mobile">
							<rect
								className="a-reward-22-mobile"
								width={38}
								height={33.933}
							/>
						</clipPath>
						<clipPath id="e-reward-22-mobile">
							<rect
								className="a-reward-22-mobile"
								width={31.529}
								height={3.548}
						...
						<clipPath id="f-reward-22-mobile">
							<rect
								className="a-reward-22-mobile"
								width={29.824}
								height={2.479}
					...
					<g>
						<g
							className="m-reward-22-mobile"
							transform="matrix(1, 0, 0, 1, -9, -6)">
							<rect
								className="b-reward-22-mobile"
								width={120}
								height={141}
								rx={8}
						...
						<text
							className="d-reward-22-mobile"
							transform="translate(9.5 77.602)">
							<tspan x={9.652} y={8}>
								{'Recocimiento por su '}
							</tspan>
							<tspan x={3.76} y={18}>
						...
						<g transform="translate(37.43 14.465)">
							<g
								className="e-reward-22-mobile"
								transform="translate(3.57 -1)">
								<g className="e-reward-22-mobile">
									<path
										className="f-reward-22-mobile"
									...
									/>
									<g
										className="i-reward-22-mobile"
										transform="translate(3.208 27.847)">
										<g className="j-reward-22-mobile">
											<path
												className="h-reward-22-mobile"
									...
									<g
										...
										<g className="k-reward-22-mobile">
											<path
												className="h-reward-22-mobile"
