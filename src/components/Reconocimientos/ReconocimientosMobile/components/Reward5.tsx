...
const Reward5Mobile: React.FC = (): JSX.Element => {
	/** States */
	const [showCard, setShowCard] = React.useState<boolean>(false)

	return (
		<g
			transform="translate(111 1289)"
			onClick={() => setShowCard(!showCard)}>
			{!showCard ? (
				<React.Fragment>
					<g
						className="dk-time-line"
						transform="matrix(1, 0, 0, 1, -202.98, -658.37)">
						<rect
							className="a-time-line"
							width={120}
							height={141}
							rx={8}
							transform="translate(202.98 658.37)"
						/>
					</g>
				...
				<React.Fragment>
					<defs>
						<style>
							{
								'.a-reward-5-mobile{fill:none;}.b-reward-5-mobile{fill:#001f5f;}.c-reward-5-mobile,.d-reward-5-mobile{fill:#fff;}.c-reward-5-mobile{font-size:10px;font-family:Silka-SemiBold, Silka;font-weight:600;}.d-reward-5-mobile{font-size:8px;font-family:Silka-Regular, Silka;}.e-reward-5-mobile{clip-path:url(#c-reward-5-mobile);}.f-reward-5-mobile{fill:#f2f2f2;}.g-reward-5-mobile{fill:#e6e6e6;}.h-reward-5-mobile{fill:#ccc;}.i-reward-5-mobile{opacity:0.4;mix-blend-mode:multiply;isolation:isolate;}.j-reward-5-mobile{clip-path:url(#e-reward-5-mobile);}.k-reward-5-mobile{clip-path:url(#f-reward-5-mobile);}.l-reward-5-mobile{fill:#e7002a;}.m-reward-5-mobile{filter:url(#a-reward-5-mobile);}'
							}
						</style>
						<filter
							id="a-reward-5-mobile"
							x={0}
							y={0}
							width={138}
							height={159}
						...
						<clipPath id="c-reward-5-mobile">
							<rect
								className="a-reward-5-mobile"
								width={38}
								height={33.933}
							/>
						</clipPath>
						<clipPath id="e-reward-5-mobile">
							<rect
								className="a-reward-5-mobile"
								width={31.529}
								height={3.548}
					...
					<g>
						<g
							className="m-reward-5-mobile"
							transform="matrix(1, 0, 0, 1, -9, -6)">
							<rect
								className="b-reward-5-mobile"
								width={120}
								height={141}
								rx={8}
						...
						<text
							className="d-reward-5-mobile"
							transform="translate(9.5 75)">
							<tspan x={14.756} y={8}>
								{'1st place implants '}
							</tspan>
							<tspan x={12.184} y={18}>
						...
						<g transform="translate(37.43 11.465)">
							<g
								className="e-reward-5-mobile"
								transform="translate(3.57 -1)">
								<g className="e-reward-5-mobile">
									<path
										className="f-reward-5-mobile"
									...
									/>
									<g
										className="i-reward-5-mobile"
										transform="translate(3.208 27.847)">
										<g className="j-reward-5-mobile">
											<path
												className="h-reward-5-mobile"
