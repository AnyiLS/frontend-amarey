...
const Reward21Mobile: React.FC = (): JSX.Element => {
	/** States */
	const [showCard, setShowCard] = React.useState<boolean>(false)

	return (
		<g
			transform="translate(248 2069)"
			onClick={() => setShowCard(!showCard)}>
			{!showCard ? (
				<React.Fragment>
					<g
						className="ef-time-line"
						transform="matrix(1, 0, 0, 1, -339.98, -1438.37)">
						<rect
							className="a-time-line"
							width={120}
							height={141}
							rx={8}
							transform="translate(339.98 1438.37)"
						/>
					</g>
					...
					<text className="da-time-line" transform="translate(60 45)">
						<tspan x={-17.106} y={11}>
							{'Nihon '}
						</tspan>
						<tspan x={-21.942} y={25}>
				...
				<React.Fragment>
					<defs>
						<style>
							{
								'.a-reward-21-mobile{fill:none;}.b-reward-21-mobile{fill:#001f5f;}.c-reward-21-mobile,.d-reward-21-mobile{fill:#fff;font-size:10px;}.c-reward-21-mobile{font-family:Silka-SemiBold, Silka;font-weight:600;}.d-reward-21-mobile{font-family:Silka-Regular, Silka;}.e-reward-21-mobile{clip-path:url(#c-reward-21-mobile);}.f-reward-21-mobile{fill:#f2f2f2;}.g-reward-21-mobile{fill:#e6e6e6;}.h-reward-21-mobile{fill:#ccc;}.i-reward-21-mobile{opacity:0.4;mix-blend-mode:multiply;isolation:isolate;}.j-reward-21-mobile{clip-path:url(#e-reward-21-mobile);}.k-reward-21-mobile{clip-path:url(#f-reward-21-mobile);}.l-reward-21-mobile{fill:#e7002a;}.m-reward-21-mobile{filter:url(#a-reward-21-mobile);}'
							}
						</style>
						<filter
							id="a-reward-21-mobile"
							x={0}
							y={0}
							width={138}
							height={159}
						...
						<clipPath id="c-reward-21-mobile">
							<rect
								className="a-reward-21-mobile"
								width={38}
								height={33.933}
							/>
						</clipPath>
						<clipPath id="e-reward-21-mobile">
							<rect
								className="a-reward-21-mobile"
								width={31.529}
								height={3.548}
						...
						<clipPath id="f-reward-21-mobile">
							<rect
								className="a-reward-21-mobile"
								width={29.824}
								height={2.479}
					...
					<g>
						<g
							className="m-reward-21-mobile"
							transform="matrix(1, 0, 0, 1, -9, -6)">
							<rect
								className="b-reward-21-mobile"
								width={120}
								height={141}
								rx={8}
						...
						<text
							className="c-reward-21-mobile"
							transform="translate(60 61.204)">
							<tspan x={-33.865} y={9}>
								{'Nihon Kohden'}
							</tspan>
						</text>
						...
						<g transform="translate(37.43 11.465)">
							<g
								className="e-reward-21-mobile"
								transform="translate(3.57 -1)">
								<g className="e-reward-21-mobile">
									<path
										className="f-reward-21-mobile"
									...
									/>
									<g
										className="i-reward-21-mobile"
										transform="translate(3.208 27.847)">
										<g className="j-reward-21-mobile">
											<path
												className="h-reward-21-mobile"
									...
									<g
										...
										<g className="k-reward-21-mobile">
											<path
												className="h-reward-21-mobile"
