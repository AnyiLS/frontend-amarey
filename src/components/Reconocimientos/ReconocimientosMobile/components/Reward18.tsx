...
const Reward18Mobile: React.FC = (): JSX.Element => {
	/** States */
	const [showCard, setShowCard] = React.useState<boolean>(false)

	return (
		<g
			transform="translate(247 1913)"
			onClick={() => setShowCard(!showCard)}>
			{!showCard ? (
				<React.Fragment>
					<g
						className="dt-time-line"
						transform="matrix(1, 0, 0, 1, -338.98, -1282.37)">
						<rect
							className="a-time-line"
							width={120}
							height={141}
							rx={8}
							transform="translate(338.98 1282.37)"
						/>
					</g>
					...
					<text
						className="dc-time-line"
						transform="translate(60 47.297)">
						<tspan x={-25.805} y={9}>
							{'Fundación '}
						</tspan>
						<tspan x={-34.38} y={21}>
				...
				<React.Fragment>
					<defs>
						<style>
							{
								'.a-reward-18-mobile{fill:none;}.b-reward-18-mobile{fill:#001f5f;}.c-reward-18-mobile,.d-reward-18-mobile{fill:#fff;}.c-reward-18-mobile{font-size:10px;font-family:Silka-SemiBold, Silka;font-weight:600;}.d-reward-18-mobile{font-size:8px;font-family:Silka-Regular, Silka;}.e-reward-18-mobile{clip-path:url(#c-reward-18-mobile);}.f-reward-18-mobile{fill:#f2f2f2;}.g-reward-18-mobile{fill:#e6e6e6;}.h-reward-18-mobile{fill:#ccc;}.i-reward-18-mobile{opacity:0.4;mix-blend-mode:multiply;isolation:isolate;}.j-reward-18-mobile{clip-path:url(#e-reward-18-mobile);}.k-reward-18-mobile{clip-path:url(#f-reward-18-mobile);}.l-reward-18-mobile{fill:#e7002a;}.m-reward-18-mobile{filter:url(#a-reward-18-mobile);}'
							}
						</style>
						<filter
							id="a-reward-18-mobile"
							x={0}
							y={0}
							width={138}
							height={159}
						...
						<clipPath id="c-reward-18-mobile">
							<rect
								className="a-reward-18-mobile"
								width={38}
								height={33.933}
							/>
						</clipPath>
						<clipPath id="e-reward-18-mobile">
							<rect
								className="a-reward-18-mobile"
								width={31.529}
								height={3.548}
						...
						<clipPath id="f-reward-18-mobile">
							<rect
								className="a-reward-18-mobile"
								width={29.824}
								height={2.479}
					...
					<g>
						<g
							className="m-reward-18-mobile"
							transform="matrix(1, 0, 0, 1, -9, -6)">
							<rect
								className="b-reward-18-mobile"
								width={120}
								height={141}
								rx={8}
						...
						<text
							className="c-reward-18-mobile"
							transform="translate(60 124.102)">
							<tspan x={-22.055} y={9}>
								{'Año 2019'}
							</tspan>
						</text>
						<text
							className="d-reward-18-mobile"
							transform="translate(9.5 85.602)">
							<tspan x={3.412} y={8}>
						...
						<g transform="translate(37.43 14.465)">
							<g
								className="e-reward-18-mobile"
								transform="translate(3.57 -1)">
								<g className="e-reward-18-mobile">
									<path
										className="f-reward-18-mobile"
									...
									/>
									<g
										className="i-reward-18-mobile"
										transform="translate(3.208 27.847)">
										<g className="j-reward-18-mobile">
											<path
												className="h-reward-18-mobile"
									...
									<g
										...
										<g className="k-reward-18-mobile">
											<path
												className="h-reward-18-mobile"
