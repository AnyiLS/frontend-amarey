...
const Reward14Mobile: React.FC = (): JSX.Element => {
	/** States */
	const [showCard, setShowCard] = React.useState<boolean>(false)

	return (
		<g
			transform="translate(112 1757)"
			onClick={() => setShowCard(!showCard)}>
			{!showCard ? (
				<React.Fragment>
					<g
						className="do-time-line"
						transform="matrix(1, 0, 0, 1, -203.98, -1126.37)">
						<rect
							className="a-time-line"
							width={120}
							height={141}
							rx={8}
							transform="translate(203.98 1126.37)"
						/>
					</g>
					...
					<text className="da-time-line" transform="translate(60 53)">
						<tspan x={-24.162} y={11}>
							{'Intuitive'}
						</tspan>
					</text>
      ...
      <style>
        {
          ".a-reward-14-mobile{fill:none;}.b-reward-14-mobile{fill:#001f5f;}.c-reward-14-mobile,.d-reward-14-mobile{fill:#fff;font-size:10px;}.c-reward-14-mobile{font-family:Silka-SemiBold, Silka;font-weight:600;}.d-reward-14-mobile{font-family:Silka-Regular, Silka;}.e-reward-14-mobile{clip-path:url(#c-reward-14-mobile);}.f-reward-14-mobile{fill:#f2f2f2;}.g-reward-14-mobile{fill:#e6e6e6;}.h-reward-14-mobile{fill:#ccc;}.i-reward-14-mobile{opacity:0.4;mix-blend-mode:multiply;isolation:isolate;}.j-reward-14-mobile{clip-path:url(#e-reward-14-mobile);}.k-reward-14-mobile{clip-path:url(#f-reward-14-mobile);}.l-reward-14-mobile{fill:#e7002a;}.m-reward-14-mobile{filter:url(#a-reward-14-mobile);}"
        }
      </style>
      <filter
        id="a-reward-14-mobile"
        x={0}
        y={0}
        width={138}
        height={159}
      ...
      <clipPath id="c-reward-14-mobile">
        <rect className="a-reward-14-mobile" width={38} height={33.933} />
      </clipPath>
      <clipPath id="e-reward-14-mobile">
        <rect className="a-reward-14-mobile" width={31.529} height={3.548} />
      </clipPath>
      <clipPath id="f-reward-14-mobile">
        <rect className="a-reward-14-mobile" width={29.824} height={2.479} />
      </clipPath>
    </defs>
    <g>
      <g className="m-reward-14-mobile" transform="matrix(1, 0, 0, 1, -9, -6)">
        <rect
          className="b-reward-14-mobile"
          width={120}
          height={141}
          rx={8}
      ...
      <text className="c-reward-14-mobile" transform="translate(60 58)">
        <tspan x={-20.135} y={9}>
          {"Intuitive"}
        </tspan>
      </text>
      <text className="c-reward-14-mobile" transform="translate(60 124)">
        <tspan x={-21.955} y={9}>
          {"Año 2017"}
        </tspan>
      </text>
      <text className="d-reward-14-mobile" transform="translate(9 78)">
        <tspan x={14.985} y={9}>
          {"Gold standard "}
        </tspan>
        <tspan x={12.4} y={21}>
      ...
      <g transform="translate(37.43 14.465)">
        <g className="e-reward-14-mobile" transform="translate(3.57 -1)">
          <g className="e-reward-14-mobile">
            <path
              className="f-reward-14-mobile"
            ...
            />
            <g className="i-reward-14-mobile" transform="translate(3.208 27.847)">
              <g className="j-reward-14-mobile">
                <path
                  className="h-reward-14-mobile"
            ...
            />
            <g className="i-reward-14-mobile" transform="translate(4.061 22.829)">
              <g className="k-reward-14-mobile">
                <path
                  className="h-reward-14-mobile"
