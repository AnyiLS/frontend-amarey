				...
				<defs>
					...
					<pattern
						...
						<image
							width={4873}
							height={3249}
							xlinkHref="/images/mobile/history/2007-2.webp"
						/>
					</pattern>
					<filter
						id="d-time-line"
					...
					<pattern
						...
						width={1}
						height={1}
						viewBox="42.166 34.423 109.49 54.347">
						<image
							preserveAspectRatio="xMidYMid slice"
							width={157.761}
							height={105.164}
							xlinkHref="/images/mobile/history/2000-2.webp"
						/>
					</pattern>
					<filter
						id="j-time-line"
					...
					<g transform="translate(0 50.011)">
						...
						<g transform="translate(-31.179 -682.753)">
							...
							<path
								...
								transform="translate(202.62 1061.26)"
							/>
							<text
						...
						<g transform="translate(117.15 330.327)" onClick={onPrev}>
							<g
								...
								transform="matrix(1, 0, 0, 1, -117.15, -381.05)">
								<path
									className="n-time-line"
