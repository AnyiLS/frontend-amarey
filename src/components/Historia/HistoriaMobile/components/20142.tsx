...
const Component20142: React.FC<TimeLine> = ({ onNext, onPrev, t, selectedLanguage }): JSX.Element => {
	return (
      ...
      <pattern id="c-time-line" width={1} height={1} viewBox="4.304 13.141 91.729 45.532">
        <image
          preserveAspectRatio="xMidYMid slice"
          width={100.337}
          height={71.814}
          xlinkHref="/images/mobile/history/20142-1.webp"
        />
      </pattern>
      <filter
        id="d-time-line"
      ...
      <pattern
        ...
        width={1}
        height={1}
        viewBox="5.452 22.713 146.856 72.895"
      >
        <image
          preserveAspectRatio="xMidYMid slice"
          width={157.761}
          height={118.321}
          xlinkHref="/images/mobile/history/20142-2.webp"
        />
      </pattern>
      <filter
        id="j-time-line"
      ...
      <g transform="translate(0 50.011)">
        ...
        <g transform="translate(-31.179 -682.753)">
          ...
          <path
            ...
            transform="translate(359.62 1061.26)"
          />
