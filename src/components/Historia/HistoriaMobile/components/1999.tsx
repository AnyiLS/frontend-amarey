...
const Component1999: React.FC<TimeLine> = ({ onNext, onPrev }): JSX.Element => {
			...
			<svg viewBox="85 0 414 485.06" preserveAspectRatio="none">
				<defs>
					...
					<pattern
						...
						width={1}
						height={1}
						viewBox="27.518 19.37 73.826 36.645">
						<image
							preserveAspectRatio="xMidYMid slice"
							width={100.337}
							height={66.885}
							xlinkHref="/images/mobile/history/1999-1.webp"
						/>
					</pattern>
					<filter
						id="d-time-line"
					...
					<pattern
						...
						<image
							width={4873}
							height={3249}
							xlinkHref="/images/mobile/history/1999-2.webp"
						/>
					</pattern>
					<filter
						id="j-time-line"
				...
				<g transform="translate(0 0.712)">
					...
					<g transform="translate(0 50.011)">
						...
						<g
							...
							transform="translate(188.222 36.872)">
							<g
								className="y-time-line"
								transform="matrix(1, 0, 0, 1, -188.22, -87.59)">
								<path
							...
							<text
								...
								transform="translate(38.818 61.872)">
								<tspan x={0} y={0}>
									{'2000'}
								</tspan>
							</text>
						...
						<g
							...
							transform="translate(112.09 162.321)">
							<path
								className="a-time-line"
						...
						<text
							...
							transform="translate(126.09 183.093)">
							<tspan x={0} y={11}>
								{t('Se crea la línea respiratoria ')}
							</tspan>
							<tspan x={0} y={25}>
								{t('con el lanzamiento de un ')}
							</tspan>
							<tspan x={0} y={39}>
								{t('surfactante pulmonar para ')}
							</tspan>
							<tspan x={0} y={53}>
								{t('el tratamiento del síndrome ')}
							</tspan>
							<tspan x={0} y={67}>
								{t('de distrés respiratorio en ')}
							</tspan>
							<tspan x={0} y={81}>
								{t('neonatos')}
							</tspan>
						...
						<g transform="translate(311.798 167.525)">
							<g
								...
								transform="matrix(1, 0, 0, 1, -311.8, -218.25)">
								<path
							...
							<text
								...
								transform="translate(57.902 99.877)">
								<tspan x={0} y={0}>
									{'1999'}
								</tspan>
							</text>
						...
						<g transform="translate(-31.179 -682.753)">
							...
							<path
								...
								transform="translate(192.788 1070.764) rotate(-180)"
							/>
							<text
