...
const Component20233: React.FC<TimeLine> = ({ onNext, onPrev, t, selectedLanguage }): JSX.Element => {
	return (
		<React.Fragment>
      ...
      <style>
        {
          ".a,.o{fill:#fff;}.b{fill:#e7002a;stroke:#e7002a;}.c,.i,.k,.m,.q,.r{fill:#001f5f;}.c{stroke:#001f5f;}.d{opacity:0.5;fill:url(#a);}.e{opacity:0.75;fill:url(#b);}.f{fill:none;stroke:#fff;stroke-width:3px;}.f,.g{opacity:0.6;}.h{fill:url(#c);}.i{font-size:10px;}.i,.m,.o{font-family:Silka-Bold, Silka;font-weight:700;}.j{clip-path:url(#h);}.k{font-size:12px;font-family:Silka-Regular, Silka;}.l{fill:url(#i);}.m{font-size:19px;}.n{fill:#e40032;}.o{font-size:13px;}.p{opacity:0.7;}.r{font-size:4px;font-family:Silka-SemiBold, Silka;font-weight:600;}.s{filter:url(#r);}.t{filter:url(#p);}.u{filter:url(#n);}.v{filter:url(#l);}.w{filter:url(#j);}.x{filter:url(#f);}.y{filter:url(#d);}"
        }
      </style>
      <linearGradient
        id="a"
      ...
      <pattern id="c" width={1} height={1} viewBox="0 4.151 100.337 49.804">
        <image
      ...
      <clipPath id="h">
        <rect className="a" width={196.535} height={117.544} />
      </clipPath>
      <pattern
        id="i"
        preserveAspectRatio="xMidYMid slice"
    ...
    <g transform="translate(0 0.712)">
      ...
      <g transform="translate(0 50.011)">
        ...
        <g className="g" transform="translate(188.222 36.872)">
          <g className="y" transform="matrix(1, 0, 0, 1, -188.22, -87.59)">
            <path
              className="h"
          ...
          <g className="x" transform="matrix(1, 0, 0, 1, -188.22, -87.59)">
            <path
              className="a"
          ...
          <text className="i" transform="translate(38.818 61.872)">
            <tspan x={0} y={0}>
              {"2023"}
            </tspan>
          </text>
        </g>
        <g className="j" transform="translate(112.09 162.321)">
          <path
            className="a"
        ...
        <text className="k" transform={selectedLanguage === 'es' ? "translate(138.857 186.093)" : "translate(133.857 186.093)"}>
          <tspan x={0} y={11}>
        ...
        <g transform="translate(311.798 167.525)">
          <g className="w" transform="matrix(1, 0, 0, 1, -311.8, -218.25)">
            <path
              className="l"
          ...
          <g className="v" transform="matrix(1, 0, 0, 1, -311.8, -218.25)">
            <path
              className="a"
          ...
          <text className="m" transform="translate(57.902 99.877)">
            <tspan x={0} y={0}>
              {"2023"}
            </tspan>
          </text>
        ...
        <g transform="translate(376.09 330.327)" onClick={onNext}>
          <g className="u" transform="matrix(1, 0, 0, 1, -376.09, -381.05)">
            <path
              className="n"
        ...
        <g transform="translate(-31.179 -682.753)">
          <g className="t" transform="matrix(1, 0, 0, 1, 31.18, 632.03)">
            <rect
              className="a"
              width={342}
              height={22}
          ...
          <g className="p" transform="translate(167.022 1070.963)">
            <path
              className="q"
          ...
          <path
            ...
            transform="translate(468.269 1070.764) rotate(-180)"
          />
          <text className="r" transform="translate(162.269 1079.08)">
            <tspan x={0} y={0}>
              {"1984"}
            </tspan>
          </text>
          <text className="r" transform="translate(182.269 1079.08)">
            <tspan x={0} y={0}>
              {"1999"}
            </tspan>
          </text>
          <text className="r" transform="translate(201.269 1079.08)">
            <tspan x={0} y={0}>
              {"2000"}
            </tspan>
          </text>
          <text className="r" transform="translate(222.269 1079.08)">
            <tspan x={0} y={0}>
              {"2007"}
            </tspan>
          </text>
          <text className="r" transform="translate(241.269 1079.08)">
            <tspan x={0} y={0}>
              {"2009"}
            </tspan>
          </text>
          <text className="r" transform="translate(262.269 1079.08)">
            <tspan x={0} y={0}>
              {"2011"}
            </tspan>
          </text>
          <text className="r" transform="translate(280.269 1079.08)">
            <tspan x={0} y={0}>
              {"2011"}
            </tspan>
          </text>
          <text className="r" transform="translate(299.269 1079.08)">
            <tspan x={0} y={0}>
              {"2012"}
            </tspan>
          </text>
          <text className="r" transform="translate(318.269 1079.08)">
            <tspan x={0} y={0}>
              {"2012"}
            </tspan>
          </text>
          <text className="r" transform="translate(338.269 1079.08)">
            <tspan x={0} y={0}>
              {"2014"}
            </tspan>
          </text>
          <text className="r" transform="translate(357.269 1079.08)">
            <tspan x={0} y={0}>
              {"2014"}
            </tspan>
          </text>
          <text className="r" transform="translate(377.269 1079.08)">
            <tspan x={0} y={0}>
              {"2016"}
            </tspan>
          </text>
          <text className="r" transform="translate(397.269 1079.08)">
            <tspan x={0} y={0}>
              {"2017"}
            </tspan>
          </text>
          <text className="r" transform="translate(416.269 1079.08)">
            <tspan x={0} y={0}>
              {"2023"}
            </tspan>
          </text>
          <text className="r" transform="translate(437.269 1079.08)">
            <tspan x={0} y={0}>
              {"2023"}
            </tspan>
          </text>
          <text className="r" transform="translate(457.269 1079.08)">
            <tspan x={0} y={0}>
              {"2023"}
            </tspan>
          </text>
          <text className="r" transform="translate(478.269 1079.08)">
            <tspan x={0} y={0}>
              {"2023"}
            </tspan>
          </text>
        ...
        <g transform="translate(117.15 330.327)" onClick={onPrev}>
          <g className="s" transform="matrix(1, 0, 0, 1, -117.15, -381.05)">
            <path
              className="n"
