...
const Component2017: React.FC<TimeLine> = ({ onNext, onPrev }): JSX.Element => {
	return (
		<React.Fragment>
      ...
      <pattern id="c-time-line" width={1} height={1} viewBox="3.275 0.448 98.533 48.909">
        <image
          ...
          width={105.082}
          height={49.804}
          xlinkHref="/images/mobile/history/2017-1.png"
        />
      </pattern>
      <filter
        id="d-time-line"
      ...
      >
        <image
          width={4740}
          height={3164}
          xlinkHref="/images/mobile/history/2017-2.png"
        />
      </pattern>
      <filter
        id="j-time-line"
    ...
    <g transform="translate(0 0.712)">
      ...
      <g transform="translate(0 50.011)">
        ...
        <text className="k-time-line" transform="translate(294.09 173.093)">
          <tspan x={0} y={11}>
