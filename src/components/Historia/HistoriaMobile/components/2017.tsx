...
const Component2017: React.FC<TimeLine> = ({ onNext, onPrev, t, selectedLanguage }): JSX.Element => {
	return (
		<React.Fragment>
      ...
      <pattern id="c-time-line" width={1} height={1} viewBox="3.275 0.448 98.533 48.909">
        <image
      ...
      <clipPath id="h-time-line">
        <rect className="a-time-line" width={210.205} height={117.544} />
      </clipPath>
      <pattern
        id="i-time-line"
        preserveAspectRatio="xMidYMid slice"
    ...
    <g transform="translate(0 0.712)">
      ...
      <g transform="translate(0 50.011)">
        ...
        <g className="g-time-line" transform="translate(293.09 36.872)">
          <g className="y-time-line" transform="matrix(1, 0, 0, 1, -293.09, -87.59)">
            <path
          ...
          <g className="x-time-line" transform="matrix(1, 0, 0, 1, -293.09, -87.59)">
            <path
          ...
          <text className="i-time-line" transform="translate(38.519 61.872)">
            <tspan x={0} y={0}>
              {"2023"}
            </tspan>
          </text>
        </g>
        <g className="j-time-line" transform="translate(273.024 162.321)">
          <path
            className="a-time-line"
            d="M196.652,117.544H13.557c-8.326,0-14.684-8.422-13.388-17.735L12.246,12.961C13.284,5.5,18.963,0,25.635,0H196.652c7.485,0,13.553,6.872,13.553,15.348V102.2c0,8.476-6.068,15.348-13.553,15.348"
            transform="translate(0)"
          />
        </g>
        <text className="k-time-line" transform={selectedLanguage === 'es' ? "translate(294.09 173.093)" : "translate(300.09 173.093)"}>
          <tspan x={0} y={11}>
          ...
          <tspan x={0} y={39}>
            {t("positivamente con los más ")}
          </tspan>
          <tspan x={0} y={53}>
            {t("altos estándares de calidad e ")}
          </tspan>
          <tspan x={0} y={67}>
        ...
        <g transform="translate(112.09 167.525)">
          <g className="w-time-line" transform="matrix(1, 0, 0, 1, -112.09, -218.25)">
            <path
          ...
          <g className="v-time-line" transform="matrix(1, 0, 0, 1, -112.09, -218.25)">
            <path
              className="a-time-line"
          ...
          <text className="m-time-line" transform="translate(55.859 99.877)">
            <tspan x={0} y={0}>
              {"2017"}
            </tspan>
          </text>
        ...
        <g transform="translate(-31.179 -682.753)">
          ...
          <path
            ...
            transform="translate(399.101 1061.26)"
          />
