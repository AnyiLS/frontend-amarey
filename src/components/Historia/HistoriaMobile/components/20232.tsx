	...
	return (
      ...
      >
        <image
          width={1920}
          height={1080}
          xlinkHref="/images/mobile/history/20232-1.webp"
        />
      </pattern>
      <filter
        id="d-time-line"
      ...
      <pattern id="i-time-line" width={1} height={1} viewBox="12.562 4.384 140.097 69.54">
        <image
          preserveAspectRatio="xMidYMid slice"
          width={165.221}
          height={78.308}
    ...
    <g transform="translate(0 0.712)">
      ...
      <g transform="translate(0 50.011)">
        ...
        <text className="k-time-line" transform="translate(295.09 189.093)">
          ...
          <tspan x={0} y={25}>
            {t("neurointervencionismo con ")}
          </tspan>
          <tspan x={0} y={39}>
            {t("la llegada del portafolio de ")}
          </tspan>
          <tspan x={0} y={53}>
            {t("CERENOVUS para el ")}
          </tspan>
          <tspan x={0} y={67}>
            {t("tratamiento de ACV.")}
          </tspan>
        </text>
        ...
        <g transform="translate(-31.179 -682.753)">
          ...
          <path
            ...
            transform="translate(438.62 1061.26)"
          />
