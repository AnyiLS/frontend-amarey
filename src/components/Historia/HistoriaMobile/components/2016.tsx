...
const Component2016: React.FC<TimeLine> = ({ onNext, onPrev }): JSX.Element => {
	return (
		<React.Fragment>
      ...
      <pattern id="c-time-line" width={1} height={1} viewBox="4.766 18.901 90.805 45.073">
        <image
          ...
          width={100.337}
          height={66.976}
          xlinkHref="/images/mobile/history/2016-1.png"
        />
      </pattern>
      <filter
        id="d-time-line"
      ...
      >
        <image
          ...
          width={157.761}
          height={112.914}
          xlinkHref="/images/mobile/history/2016-2.png"
        />
      </pattern>
      <filter
        id="j-time-line"
    ...
    <g transform="translate(0 0.712)">
      ...
      <g transform="translate(0 50.011)">
        ...
        <text className="k-time-line" transform="translate(138.857 186.093)">
          ...
          <tspan x={0} y={25}>
            {"otorgan la Mención de "}
          </tspan>
          <tspan x={0} y={39}>
            {"Honor a Amarey Nova "}
          </tspan>
          <tspan x={0} y={53}>
            {"Medical en la categoría "}
          </tspan>
          <tspan x={0} y={67}>
