			...
			<svg viewBox="85 0 414 485.06" preserveAspectRatio="none">
				<defs>
					...
					<pattern
						...
						width={1}
						height={1}
						viewBox="16.702 4.776 66.934 33.224">
						<image
							preserveAspectRatio="xMidYMid slice"
							width={100.337}
							height={57.426}
							xlinkHref="/images/mobile/history/2007-1.png"
						/>
					</pattern>
					<filter
						id="d-time-line"
					...
					<pattern
						...
						width={1}
						height={1}
						viewBox="8.743 19.175 140.276 69.629">
						<image
							preserveAspectRatio="xMidYMid slice"
							width={157.761}
							height={115.789}
				...
				<g transform="translate(0 0.712)">
					...
					<g transform="translate(0 50.011)">
						...
						<text
							...
							transform="translate(122.09 179.093)">
							<tspan x={0} y={11}>
						...
						<g transform="translate(-31.179 -682.753)">
							...
							<path
								...
								transform="translate(232.437 1070.764) rotate(-180)"
							/>
							<text
