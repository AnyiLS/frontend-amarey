...
const Component20122: React.FC<TimeLine> = ({ onNext, onPrev, t, selectedLanguage }): JSX.Element => {
	return (
		<React.Fragment>
      ...
      <pattern
        ...
        width={1}
        height={1}
        viewBox="24.898 41.626 104.194 51.719"
      >
        <image
          preserveAspectRatio="xMidYMid slice"
          width={157.761}
    ...
    <g transform="translate(0 0.712)">
      ...
      <g transform="translate(0 50.011)">
        ...
        <text className="k-time-line" transform={selectedLanguage === 'es' ? "translate(309.59 193.093)" : "translate(299.59 193.093)"}>
          <tspan x={0} y={11}>
            {t("Se inauguran cinco ")}
          </tspan>
          <tspan x={0} y={25}>
            {t("sedes propias en ")}
          </tspan>
          <tspan x={0} y={39}>
            {t("Bogotá, Cali, Medellín, ")}
          </tspan>
          <tspan x={0} y={53}>
            {t("Barranquilla y Pereira.")}
          </tspan>
        </text>
        ...
        <g transform="translate(-31.179 -682.753)">
          ...
          <path
            ...
            transform="translate(320.62 1061.26)"
          />
