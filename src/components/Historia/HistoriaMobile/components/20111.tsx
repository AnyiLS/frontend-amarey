...
const Component20111: React.FC<TimeLine> = ({ onNext, onPrev, t }): JSX.Element => {
	return (
		<React.Fragment>
      ...
      >
        <image
          width={1920}
          height={1280}
          xlinkHref="/images/mobile/history/20111-1.webp"
        />
      </pattern>
      <filter
        id="d-time-line"
      ...
      <pattern id="i-time-line" width={1} height={1} viewBox="0 21.997 157.761 78.308">
        <image
          preserveAspectRatio="xMidYMid slice"
          width={157.761}
          height={105.174}
          xlinkHref="/images/mobile/history/20111-2.webp"
        />
      </pattern>
      <filter
        id="j-time-line"
    ...
    <g transform="translate(0 0.712)">
      ...
      <g transform="translate(0 50.011)">
        ...
        <text className="k-time-line" transform="translate(129.09 186.093)">
          <tspan x={0} y={11}>
            {t("Se crea la línea de apoyo ")}
          </tspan>
          <tspan x={0} y={25}>
            {t("en gestión de tecnología ")}
          </tspan>
          <tspan x={0} y={39}>
            {t("biomédica en el modelo ")}
          </tspan>
          <tspan x={0} y={53}>
            {t("inhouse y servicio de ")}
          </tspan>
          <tspan x={0} y={67}>
        ...
        <g transform="translate(-31.179 -682.753)">
          ...
          <path
            ...
            transform="translate(271.353 1070.764) rotate(-180)"
          />
