...
const Component20141: React.FC<TimeLine> = ({ onNext, onPrev, t }): JSX.Element => {
	return (
		<React.Fragment>
      ...
      <pattern id="c-time-line" width={1} height={1} viewBox="6.076 15.74 88.185 43.772">
        <image
          preserveAspectRatio="xMidYMid slice"
          width={100.337}
          height={75.253}
          xlinkHref="/images/mobile/history/20141-1.webp"
        />
      </pattern>
      <filter
        id="d-time-line"
      ...
      <pattern id="i-time-line" width={1} height={1} viewBox="3.616 19.098 150.53 74.719">
        <image
          preserveAspectRatio="xMidYMid slice"
          width={157.761}
          height={112.914}
          xlinkHref="/images/mobile/history/20141-2.webp"
        />
      </pattern>
      <filter
        id="j-time-line"
    ...
    <g transform="translate(0 0.712)">
      ...
      <g transform="translate(0 50.011)">
        ...
        <text className="k-time-line" transform="translate(145.357 200.093)">
          <tspan x={0} y={11}>
            {t("Obtiene el Premio ")}
          </tspan>
          <tspan x={0} y={25}>
        ...
        <g transform="translate(-31.179 -682.753)">
          ...
          <path
            ...
            transform="translate(350.437 1070.764) rotate(-180)"
          />
