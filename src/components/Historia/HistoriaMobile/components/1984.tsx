			...
			<svg viewBox="85 0 414 485.06" preserveAspectRatio="none">
				<defs>
					...
					<pattern
						...
						width="100%"
						height="100%"
						viewBox="0 0 4873 3249">
						<image
							width={4873}
							height={3249}
							xlinkHref="/images/mobile/history/1984-1.webp"
						/>
					</pattern>
					<filter
						id="d-time-line"
					...
					<pattern
						...
						width={1}
						height={1}
						viewBox="8.494 10.368 140.774 69.876">
						<image
							preserveAspectRatio="xMidYMid slice"
							width={157.761}
							height={90.611}
							xlinkHref="/images/mobile/history/1984-2.webp"
						/>
					</pattern>
					<filter
						id="j-time-line"
				...
				<g transform="translate(0 0.712)">
					...
					<g transform="translate(0 50.011)">
						...
						<g
							...
							transform="translate(293.09 36.872)">
							<g
								className="x-time-line"
								transform="matrix(1, 0, 0, 1, -293.09, -87.59)">
								<path
									className="h-time-line"
									d="M100.3,6.092,93.027,49.8H24.691c-11.031,0-17.726-7.982-19.134-11.515L.038,6.113C-.307,2.875,1.734,0,4.374,0h91.59c2.634,0,4.669,2.861,4.339,6.092"
									transform="translate(293.09 87.59)"
								/>
							</g>
							<g
								...
								<path
									className="a-time-line"
									d="M38.306,143.625c-11.031,0-17.726-7.982-19.134-11.515l4.365,25.438c.284,2.7,2.139,4.71,4.336,4.71H58.3l2.056,3.561,2.361,4.089a1.236,1.236,0,0,0,2.14,0l2.361-4.089,2.056-3.561h30.72c2.2,0,4.061-2.026,4.339-4.73l2.313-13.9Z"
									transform="translate(279.47 -6.23)"
								/>
							</g>
							<text
								className="i-time-line"
								transform="translate(38.519 61.872)">
								<tspan x={0} y={0}>
									{'1999'}
								</tspan>
							</text>
						...
						<g
							className="j-time-line"
							transform="translate(273.024 162.321)">
							<path
								className="a-time-line"
								d="M183.863,117.544H12.675c-7.785,0-13.729-8.422-12.518-17.735L11.45,12.961C12.42,5.5,17.73,0,23.968,0h159.9c7,0,12.672,6.872,12.672,15.348V102.2c0,8.476-5.673,15.348-12.672,15.348"
								transform="translate(0)"
							/>
						</g>
						<text
							className="k-time-line"
							transform="translate(294.09 172.093)">
							<tspan x={0} y={11}>
								{t('Nace Amarey Nova Medical')}
							</tspan>
							<tspan x={0} y={25}>
								{t('al obtener la distribución')}
							</tspan>
							<tspan x={0} y={39}>
								{t('de la inmunoglobulina')}
							</tspan>
							<tspan x={0} y={53}>
								{t('humana IgG enriquecida,')}
							</tspan>
							<tspan x={0} y={67}>
								{t('que le dio vida al')}
							</tspan>
							<tspan x={0} y={81}>
								{t('pentámero que ha sido el ')}
							</tspan>
							<tspan x={0} y={95}>
								{t('símbolo de la compañía. ')}
							</tspan>
						</text>
						<g transform="translate(112.09 167.525)">
							<g
								className="v-time-line"
								transform="matrix(1, 0, 0, 1, -112.09, -218.25)">
								<path
							...
							<text
								className="m-time-line"
								transform="translate(55.859 99.877)">
								<tspan x={0} y={0}>
									{'1984'}
								</tspan>
							</text>
						...
						<g transform="translate(376.09 330.327)" onClick={onNext}>
							<g
								className="t-time-line"
								transform="matrix(1, 0, 0, 1, -376.09, -381.05)">
								<path
						...
						<g transform="translate(-31.179 -682.753)">
							<g
								...
								transform="matrix(1, 0, 0, 1, 31.18, 632.03)">
								<rect
									className="a-time-line"
									width={342}
									height={22}
							...
							<g
								className="p-time-line"
								transform="translate(167.022 1070.963)">
								<path
							...
							<path
								...
								transform="translate(162.269 1061.06)"
							/>
							<text
								className="r-time-line"
								transform="translate(162.269 1079.08)">
								<tspan x={0} y={0}>
									{'1984'}
								</tspan>
							</text>
							<text
								className="r-time-line"
								transform="translate(182.269 1079.08)">
								<tspan x={0} y={0}>
									{'1999'}
								</tspan>
							</text>
							<text
								className="r-time-line"
								transform="translate(201.269 1079.08)">
								<tspan x={0} y={0}>
									{'2000'}
								</tspan>
							</text>
							<text
								className="r-time-line"
								transform="translate(222.269 1079.08)">
								<tspan x={0} y={0}>
									{'2007'}
								</tspan>
							</text>
							<text
								className="r-time-line"
								transform="translate(241.269 1079.08)">
								<tspan x={0} y={0}>
									{'2009'}
								</tspan>
							</text>
							<text
								className="r-time-line"
								transform="translate(262.269 1079.08)">
								<tspan x={0} y={0}>
									{'2011'}
								</tspan>
							</text>
							<text
								className="r-time-line"
								transform="translate(280.269 1079.08)">
								<tspan x={0} y={0}>
									{'2011'}
								</tspan>
							</text>
							<text
								className="r-time-line"
								transform="translate(299.269 1079.08)">
								<tspan x={0} y={0}>
									{'2012'}
								</tspan>
							</text>
							<text
								className="r-time-line"
								transform="translate(318.269 1079.08)">
								<tspan x={0} y={0}>
									{'2012'}
								</tspan>
							</text>
							<text
								className="r-time-line"
								transform="translate(338.269 1079.08)">
								<tspan x={0} y={0}>
									{'2014'}
								</tspan>
							</text>
							<text
								className="r-time-line"
								transform="translate(357.269 1079.08)">
								<tspan x={0} y={0}>
									{'2014'}
								</tspan>
							</text>
							<text
								className="r-time-line"
								transform="translate(377.269 1079.08)">
								<tspan x={0} y={0}>
									{'2016'}
								</tspan>
							</text>
							<text
								className="r-time-line"
								transform="translate(397.269 1079.08)">
								<tspan x={0} y={0}>
									{'2017'}
								</tspan>
							</text>
							<text
								className="r-time-line"
								transform="translate(416.269 1079.08)">
								<tspan x={0} y={0}>
									{'2023'}
								</tspan>
							</text>
							<text
								className="r-time-line"
								transform="translate(437.269 1079.08)">
								<tspan x={0} y={0}>
									{'2023'}
								</tspan>
							</text>
							<text
								className="r-time-line"
								transform="translate(457.269 1079.08)">
								<tspan x={0} y={0}>
									{'2023'}
								</tspan>
							</text>
							<text
								className="r-time-line"
								transform="translate(478.269 1079.08)">
								<tspan x={0} y={0}>
									{'2023'}
								</tspan>
							</text>
