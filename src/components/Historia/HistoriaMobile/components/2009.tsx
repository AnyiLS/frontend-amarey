...
const Component2009: React.FC<TimeLine> = ({ onNext, onPrev }): JSX.Element => {
	return (
      ...
      <pattern
        ...
        width="100%"
        height="100%"
        viewBox="0 0 5616 3744"
      >
        <image
          width={5616}
          height={3744}
          xlinkHref="/images/mobile/history/2009-1.jpg"
        />
      </pattern>
      <filter
        id="d-time-line"
      ...
      <pattern id="i-time-line" width={1} height={1} viewBox="16.44 2.331 119.08 59.108">
        <image
          preserveAspectRatio="xMidYMid slice"
          width={157.761}
          height={90.291}
          xlinkHref="/images/mobile/history/2009-2.png"
        />
      </pattern>
      <filter
        id="j-time-line"
      ...
      <g transform="translate(0 50.011)">
        ...
        <g transform="translate(-31.179 -682.753)">
          ...
          <path
            ...
            transform="translate(241.269 1061.26)"
          />
