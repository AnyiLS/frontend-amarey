...
const Component20231: React.FC<TimeLine> = ({ onNext, onPrev, t, selectedLanguage }): JSX.Element => {
	return (
      ...
      <pattern id="c-time-line" width={1} height={1} viewBox="7.991 2.789 89.1 44.227">
        <image
          preserveAspectRatio="xMidYMid slice"
          width={105.082}
          height={49.804}
          xlinkHref="/images/mobile/history/20231-1.webp"
        />
      </pattern>
      <filter
        id="d-time-line"
      ...
      <pattern
        ...
        viewBox="0 0 768 364"
      >
        <image width={768} height={364} xlinkHref="/images/mobile/history/20231-2.webp" />
      </pattern>
      <filter
        id="j-time-line"
        x={302.798}
      ...
      <g transform="translate(0 50.011)">
        ...
        <g transform="translate(-31.179 -682.753)">
          ...
          <path
            ...
            transform="translate(428.437 1070.764) rotate(-180)"
          />
