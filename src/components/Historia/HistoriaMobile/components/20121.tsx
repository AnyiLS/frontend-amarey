...
const Component20121: React.FC<TimeLine> = ({ onNext, onPrev }): JSX.Element => {
	return (
      ...
      <pattern id="c-time-line" width={1} height={1} viewBox="15.607 24.631 69.122 34.31">
        <image
          preserveAspectRatio="xMidYMid slice"
          width={100.337}
          height={103.197}
          xlinkHref="/images/mobile/history/20121-1.jpg"
        />
      </pattern>
      <filter
        id="d-time-line"
      ...
      >
        <image
          width={1018}
          height={702}
          xlinkHref="/images/mobile/history/20121-2.png"
        />
      </pattern>
      <filter
        id="j-time-line"
      ...
      <g transform="translate(0 50.011)">
        ...
        <g transform="translate(-31.179 -682.753)">
          ...
          <path
            ...
            transform="translate(310.437 1070.764) rotate(-180)"
          />
