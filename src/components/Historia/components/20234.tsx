		...
		<svg viewBox="0 0 1920 874.839">
			...
			<g transform="translate(0 86.471)">
				...
				<text
					...
					<tspan x={0} y={26}>
						{t('Distribución Logística – CEDI en ')}
					</tspan>
					<tspan x={0} y={52}>
						{t('la zona industrial de Montevideo ')}
					</tspan>
					<tspan x={0} y={78}>
						{t('en Bogotá, con el objetivo de ')}
					</tspan>
					<tspan x={0} y={104}>
						{t('lograr mejores niveles de servicio ')}
					</tspan>
					<tspan x={0} y={130}>
						{t('logístico para los clientes.')}
					</tspan>
				</text>
				<g transform="translate(0 -365.714)" onClick={onClick}>
					<g
						...
						<path
							className="item-107-i cursor-pointer"
					...
					/>
					<text
						className="item-107-j cursor-pointer"
				...
				<g transform="translate(142 613.861)" onClick={onLess}>
					<g
						className="item-107-p cursor-pointer"
				...
				<g transform="translate(90.016 -358.349)">
					...
					/>
					<text
						className="item-107-n cursor-pointer"
