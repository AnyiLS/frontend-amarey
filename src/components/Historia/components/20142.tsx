...
const LifeLine20142: React.FC<ILifeLine2000> = ({ onClick, onLess, handleChangeStepForce, t, selectedLanguage }) => {
	return (
		<svg viewBox="0 0 1920 874.839">
			<defs>
				...
				<pattern
					...
					<image
						width={693}
						height={496}
						xlinkHref="/images/history/2014-2-2.webp"
					/>
				</pattern>
				<filter
					id="item-107-d"
				...
				<pattern
					...
					<image
						...
						width={475.286}
						height={356.465}
						xlinkHref="/images/history/2014-2-1.webp"
					/>
				</pattern>
				<filter
					id="item-107-l"
			...
			<g transform="translate(0 50.471)">
				...
				<text
					...
					transform={selectedLanguage === 'es' ? "translate(1040 346.286)" : "translate(1040 366.286)"}>
					<tspan x={0} y={0}>
