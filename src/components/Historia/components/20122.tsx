	...
	return (
      ...
      >
        <image
          ...
          width={302.286}
          height={216.355}
          xlinkHref="/images/history/2012-2-1.webp"
        />
      </pattern>
      <filter
        id="item-107-d"
      ...
      >
        <image
          ...
          width={475.286}
          height={488.832}
          xlinkHref="/images/history/2012-1-2_11zon.webp"
        />
      </pattern>
      <filter
        id="item-107-l"
      ...
      <text className="item-107-k" transform="translate(1026 337.286)">
        <tspan x={0} y={23}>
          {t("Se inauguran cinco sedes ")}
        </tspan>
        <tspan x={0} y={49}>
          {t("propias en Bogotá, Cali, ")}
        </tspan>
        <tspan x={0} y={75}>
          {t("Medellín, Barranquilla y Pereira.")}
        </tspan>
      </text>
