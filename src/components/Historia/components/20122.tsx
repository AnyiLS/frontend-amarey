...
const LifeLine20122: React.FC<ILifeLine2000> = ({
  onClick,
  onLess,
  ...
  return (
    <svg viewBox="0 0 1920 874.839">
      ...
      <g transform="translate(0 50.471)">
        ...
        <text className="item-107-k" transform={selectedLanguage === 'es' ? "translate(1026 337.286)" : "translate(1056 328.286)"}>
          <tspan x={0} y={23}>
          ...
          {selectedLanguage === "en" && (
            <tspan x={0} y={101}>
              {t("Medellín, Barranquilla y Pereira.").split(" ")
                  .slice(4, 8)
                  .join(" ")}
            </tspan>
          )}
        ...
        <g transform="translate(0 -329.714)" onClick={onClick}>
          <g
            className="item-107-v cursor-pointer"
        ...
        <g transform="translate(142 649.861)" onClick={onLess}>
          <g
            className="item-107-s cursor-pointer"
        ...
        <g transform="translate(90.015 -322.349)">
          ...
          />
          <text
            className="item-107-q cursor-pointer"
