...
const LifeLine20232: React.FC<ILifeLine2000> = ({ onClick, onLess, handleChangeStepForce, t, selectedLanguage }) => {
	return (
		<svg viewBox="0 0 1920 874.839">
			<defs>
				...
				<pattern
					...
					<image
						...
						width={302.286}
						height={170.036}
						xlinkHref="/images/history/2023-2-2.webp"
					/>
				</pattern>
				<filter
					id="item-107-d"
				...
				<pattern
					...
					<image
						...
						width={497.761}
						height={235.918}
						xlinkHref="/images/history/2023-2-1.webp"
					/>
				</pattern>
				<filter
					id="item-107-l"
			...
			<g transform="translate(0 50.471)">
				...
				<text
					...
					transform={selectedLanguage === 'es' ? "translate(1035 309.286)" : "translate(1025 319.286)"}>
					<tspan x={0} y={23}>
