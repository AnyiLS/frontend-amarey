		...
		<svg viewBox="0 0 1920 874.839">
			<defs>
				...
				<pattern
					...
					<image
						...
						width={475.286}
						height={267.349}
						xlinkHref="/images/history/2023-3-1.webp"
					/>
				</pattern>
				<filter
					id="item-107-l"
			...
			<g transform="translate(0 50.471)">
				...
				<text
					...
					<tspan x={0} y={23}>
						{t('Grupo Amarey renueva su ')}
					</tspan>
					<tspan x={0} y={49}>
						{t('identidad de marca, logrando ')}
					</tspan>
					<tspan x={0} y={75}>
						{t('que refleje los valores, la cultura ')}
					</tspan>
					<tspan x={0} y={101}>
						{t('y la misión de la compañía.')}
					</tspan>
				</text>
