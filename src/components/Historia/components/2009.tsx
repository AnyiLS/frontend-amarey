		...
		<svg viewBox="0 0 1920 874.839">
			...
			<g transform="translate(0 50.471)">
				...
				<text
					...
					<tspan x={0} y={127}>
						{t('diagnósticas oncológicas y ')}
					</tspan>
					<tspan x={0} y={153}>
						{t('cuidado avanzado de heridas. ')}
					</tspan>
				</text>
				<g transform="translate(0 -329.714)" onClick={onClick}>
					<g
						className="item-104-v cursor-pointer"
						transform="matrix(1, 0, 0, 1, 0, 279.24)">
						<path
							className="item-104-l cursor-pointer"
				...
				<g transform="translate(142 649.861)" onClick={onLess}>
					<g
						className="item-104-s cursor-pointer"
				...
				<g transform="translate(90.016 -322.349)">
					...
					/>
					<text
						className="item-104-q cursor-pointer"
