...
const LifeLine2000: React.FC<ILifeLine2000> = ({ onClick, onLess, handleChangeStepForce, t, selectedLanguage }): JSX.Element => {
    return (
        ...
        <defs>
          ...
          >
            <image
              ...
              width={302.286}
              height={221.864}
              xlinkHref="/images/history/2000-1.webp"
            />
          </pattern>
          <filter
            id="item-102-d"
          ...
          >
            <image
              ...
              width={475.286}
              height={316.827}
              xlinkHref="/images/history/2000-2.webp"
            />
          </pattern>
          <filter
            id="item-102-l"
        ...
        <g transform="translate(0 -283.366)" onClick={onClick}>
          <g className="item-102-v cursor-pointer" transform="matrix(1, 0, 0, 1, 0, 283.37)">
            <path
              className="item-102-l cursor-pointer"
          ...
          <path
            className="item-102-a cursor-pointer"
            d="M45.263,0V24.412L66.419,12.2,56.314,6.375Z"
            transform="translate(1673.737 1007.794)"
          />
          <text className="item-102-m cursor-pointer" transform="translate(1539 1032)">
            <tspan x={0} y={0}>
              {t("Avanzar")}
            </tspan>
          </text>
        ...
        <g transform="translate(142 696.21)" onClick={onLess}>
          <g className="item-102-s cursor-pointer" transform="matrix(1, 0, 0, 1, -142, -696.21)">
            <path
              className="item-102-l cursor-pointer"
          ...
          />
          <text className="item-102-m cursor-pointer" transform="translate(66 52.425)">
            <tspan x={0} y={0}>
              {t("Regresar")}
            </tspan>
          </text>
        ...
        <g transform="translate(90.016 -276.001)">
          ...
          />
          <text className="item-102-q cursor-pointer" transform="translate(199 1132)"  onClick={() => handleChangeStepForce(0)}>
            <tspan x={0} y={0}>
              {"1984"}
            </tspan>
          </text>
          <text className="item-102-q cursor-pointer" transform="translate(279 1132)"  onClick={() => handleChangeStepForce(1)}>
            <tspan x={0} y={0}>
              {"1999"}
            </tspan>
          </text>
          <text className="item-102-q cursor-pointer" transform="translate(358 1132)"  onClick={() => handleChangeStepForce(2)}>
            <tspan x={0} y={0}>
              {"2000"}
            </tspan>
          </text>
          <text className="item-102-q cursor-pointer" transform="translate(441 1132)"  onClick={() => handleChangeStepForce(3)}>
            <tspan x={0} y={0}> 
              {"2007"}
            </tspan>
          </text>
          <text className="item-102-q cursor-pointer" transform="translate(522 1132)"  onClick={() => handleChangeStepForce(4)}>
            <tspan x={0} y={0}>
              {"2009"}
            </tspan>
          </text>
          <text className="item-102-q cursor-pointer" transform="translate(605 1132)"  onClick={() => handleChangeStepForce(5)}>
            <tspan x={0} y={0}>
              {"2011"}
            </tspan>
          </text>
          <text className="item-102-q cursor-pointer" transform="translate(681 1132)"  onClick={() => handleChangeStepForce(6)}>
            <tspan x={0} y={0}>
              {"2011"}
            </tspan>
          </text>
          <text className="item-102-q cursor-pointer" transform="translate(758 1132)"  onClick={() => handleChangeStepForce(7)}>
            <tspan x={0} y={0}>
              {"2012"}
            </tspan>
          </text>
          <text className="item-102-q cursor-pointer" transform="translate(836 1132)"  onClick={() => handleChangeStepForce(8)}>
            <tspan x={0} y={0}>
              {"2012"}
            </tspan>
          </text>
          <text className="item-102-q cursor-pointer" transform="translate(915 1132)"  onClick={() => handleChangeStepForce(9)}>
            <tspan x={0} y={0}>
              {"2014"}
            </tspan>
          </text>
          <text className="item-102-q cursor-pointer" transform="translate(993 1132)"  onClick={() => handleChangeStepForce(10)}>
            <tspan x={0} y={0}>
              {"2014"}
            </tspan>
          </text>
          <text className="item-102-q cursor-pointer" transform="translate(1073 1132)"  onClick={() => handleChangeStepForce(11)}>
            <tspan x={0} y={0}>
              {"2016"}
            </tspan>
          </text>
          <text className="item-102-q cursor-pointer" transform="translate(1150 1132)"  onClick={() => handleChangeStepForce(12)}>
            <tspan x={0} y={0}>
              {"2017"}
            </tspan>
          </text>
          <text className="item-102-q cursor-pointer" transform="translate(1229 1132)"  onClick={() => handleChangeStepForce(13)}>
            <tspan x={0} y={0}>
              {"2023"}
            </tspan>
          </text>
          <text className="item-102-q cursor-pointer" transform="translate(1307 1132)"  onClick={() => handleChangeStepForce(14)}>
            <tspan x={0} y={0}>
              {"2023"}
            </tspan>
          </text>
          <text className="item-102-q cursor-pointer" transform="translate(1386 1132)"  onClick={() => handleChangeStepForce(15)}>
            <tspan x={0} y={0}>
              {"2023"}
            </tspan>
          </text>
          <text className="item-102-q cursor-pointer" transform="translate(1464 1132)"  onClick={() => handleChangeStepForce(16)}>
            <tspan x={0} y={0}>
              {"2023"}
            </tspan>
          </text>
