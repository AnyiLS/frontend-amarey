		...
		<React.Fragment>
			<svg viewBox="-150 0 1920 998.106">
				<defs>
					<style>
						{
							'.a-agoust,.n-agoust{fill:none;}.b-agoust,.l-agoust,.o-agoust,.p-agoust{fill:#001f5f;}.c-agoust{fill:#c5dbf7;}.d-agoust,.j-agoust,.m-agoust{fill:#182856;}.d-agoust,.l-agoust{font-size:24px;}.d-agoust{font-family:Silka-Regular, Silka;}.e-agoust{fill:#e40032;}.f-agoust{fill:#c7c7cc;}.g-agoust,.h-agoust{fill:#fff;}.h-agoust,.m-agoust{font-size:42px;}.h-agoust,.j-agoust,.m-agoust{font-family:Silka-SemiBold, Silka;font-weight:600;}.i-agoust{clip-path:url(#e-agoust);}.j-agoust{font-size:32px;}.k-agoust{clip-path:url(#f-agoust);}.l-agoust{font-family:Silka-Medium, Silka;font-weight:500;}.n-agoust{stroke:#e40032;stroke-width:3px;}.o-agoust{font-size:55px;}.o-agoust,.p-agoust{font-family:Kiona-Bold, Kiona;font-weight:700;}.p-agoust{font-size:28px;}.q-agoust{clip-path:url(#k-agoust);}.r-agoust{filter:url(#i-agoust);}.s-agoust{filter:url(#g-agoust);}.t-agoust{filter:url(#c-agoust);}.u-agoust{filter:url(#a-agoust);}'
						}
					</style>
					<filter
						id="a-agoust"
					...
					<clipPath id="e-agoust">
						<rect className="a-agoust" width={567} height={40} />
					</clipPath>
					<clipPath id="f-agoust">
						<rect className="a-agoust" width={567} height={232} />
					</clipPath>
					<filter
						id="g-agoust"
						x={819}
				...
				<g className="r-agoust" transform="matrix(1, 0, 0, 1, 0, 0)">
					<path
						className="g-agoust"
				...
				<text className="p-agoust" transform="translate(1436 743.961)">
					<tspan x={-344.008} y={0}>
