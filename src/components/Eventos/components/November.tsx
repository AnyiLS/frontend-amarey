...
const November: React.FC = (): JSX.Element => {
	return (
		<React.Fragment>
    ...
    <defs>
      <style>
        {
          ".a-november,.n-november{fill:none;}.b-november,.l-november,.o-november,.p-november{fill:#001f5f;}.c-november{fill:#c5dbf7;}.d-november,.j-november,.m-november{fill:#182856;}.d-november,.l-november{font-size:24px;}.d-november{font-family:Silka-Regular, Silka;}.e-november{fill:#e40032;}.f-november{fill:#c7c7cc;}.g-november,.h-november{fill:#fff;}.h-november,.m-november{font-size:42px;}.h-november,.j-november,.m-november{font-family:Silka-SemiBold, Silka;font-weight:600;}.i-november{clip-path:url(#e-november);}.j-november{font-size:32px;}.k-november{clip-path:url(#f-november);}.l-november{font-family:Silka-Medium, Silka;font-weight:500;}.n-november{stroke:#e40032;stroke-width:3px;}.o-november{font-size:55px;}.o-november,.p-november{font-family:Kiona-Bold, Kiona;font-weight:700;}.p-november{font-size:28px;}.q-november{clip-path:url(#k-november);}.r-november{filter:url(#i-november);}.s-november{filter:url(#g-november);}.t-november{filter:url(#c-november);}.u-november{filter:url(#a-november);}"
        }
      </style>
      <filter
        id="a-november"
      ...
      <clipPath id="e-november">
        <rect className="a-november" width={567} height={40} />
      </clipPath>
      <clipPath id="f-november">
        <rect className="a-november" width={567} height={232} />
      </clipPath>
      <filter
        id="g-november"
        x={819}
      ...
      <clipPath id="k-november">
        <rect className="a-november" width={492.426} height={137.787} />
      </clipPath>
    </defs>
    <path
      className="b-november"
    ...
    <g transform="translate(-210.89 -41.981)">
      <g transform="translate(1440.747 906.884)">
        <g className="u-november" transform="matrix(1, 0, 0, 1, -1229.86, -864.9)">
          <path
            className="f-november"
    ...
    <g transform="translate(-140 -133.981)">
      <g className="i-november" transform="translate(140 557)">
      ...
      <g className="k-november" transform="translate(140 610)">
        <g transform="translate(-140 -557)">
          <text className="l-november" transform="translate(140 557)">
            <tspan x={-13.716} y={23}>
              {"27"}
            </tspan>
          </text>
    ...
    <g className="r-november" transform="matrix(1, 0, 0, 1, 0, 0)">
      <path
        className="g-november"
    ...
    <text className="p-november" transform="translate(1436 743.961)">
      <tspan x={-344.008} y={0}>
