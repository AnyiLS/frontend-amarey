...
const May16: React.FC<ICalendar> = ({ next, prev, onChangeDay, onChangeMonth, onLessMonth }) => {
  /** Variables */
  ...
  return (
    <svg viewBox="-150 0 1920 998.106">
      ...
      <text className="k-item-1813 cursor-pointer" transform="translate(1569 320.106)">
        <tspan x={-381.475} y={0}>
