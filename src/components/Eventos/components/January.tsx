...
const January: React.FC = (): JSX.Element => {
	return (
		<React.Fragment>
    ...
    <defs>
      ...
      <clipPath id="k-january">
        <rect className="a-january" width={492.426} height={137.787} />
      </clipPath>
    </defs>
    <path
      className="b-january"
    ...
    <g transform="translate(-210.89 -41.981)">
      <g transform="translate(1440.747 906.884)">
        <g className="u-january" transform="matrix(1, 0, 0, 1, -1229.86, -864.9)">
          <path
            className="f-january"
      ...
      <g transform="translate(1224.426 906.884)">
        <g className="t-january" transform="matrix(1, 0, 0, 1, -1013.54, -864.9)">
          <path
            className="f-january"
    ...
    <g transform="translate(-140 -133.894)">
      ...
      <g className="k-january" transform="translate(140 610)">
        <g transform="translate(-140 -557)">
          <text className="l-january" transform="translate(140 557)">
            <tspan x={-14.508} y={23}>
              {"29"}
            </tspan>
          </text>
    ...
    <g className="r-january" transform="matrix(1, 0, 0, 1, 0, 0)">
      <path
        className="g-january"
    ...
    <text className="p-january" transform="translate(1436 743.961)">
      <tspan x={-344.008} y={0}>
