...
const July: React.FC = (): JSX.Element => {
	return (
		<React.Fragment>
    ...
    <defs>
      <style>
        {
          ".a-july,.n-july{fill:none;}.b-july,.l-july,.o-july,.p-july{fill:#001f5f;}.c-july{fill:#c5dbf7;}.d-july,.j-july,.m-july{fill:#182856;}.d-july,.l-july{font-size:24px;}.d-july{font-family:Silka-Regular, Silka;}.e-july{fill:#e40032;}.f-july{fill:#c7c7cc;}.g-july,.h-july{fill:#fff;}.h-july,.m-july{font-size:42px;}.h-july,.j-july,.m-july{font-family:Silka-SemiBold, Silka;font-weight:600;}.i-july{clip-path:url(#e-july);}.j-july{font-size:32px;}.k-july{clip-path:url(#f-july);}.l-july{font-family:Silka-Medium, Silka;font-weight:500;}.n-july{stroke:#e40032;stroke-width:3px;}.o-july{font-size:55px;}.o-july,.p-july{font-family:Kiona-Bold, Kiona;font-weight:700;}.p-july{font-size:28px;}.q-july{clip-path:url(#k-july);}.r-july{filter:url(#i-july);}.s-july{filter:url(#g-july);}.t-july{filter:url(#c-july);}.u-july{filter:url(#a-july);}"
        }
      </style>
      <filter
        id="a-july"
      ...
      <clipPath id="e-july">
        <rect className="a-july" width={567} height={40} />
      </clipPath>
      <clipPath id="f-july">
        <rect className="a-july" width={567} height={232} />
      </clipPath>
      <filter
        id="g-july"
        x={819}
      ...
      <clipPath id="k-july">
        <rect className="a-july" width={492.426} height={137.787} />
      </clipPath>
    </defs>
    <path
      className="b-july"
    ...
    <g transform="translate(-140 -79.981)">
      ...
      />
      <text className="d-july" transform="translate(458 893)">
        <tspan x={0} y={0}>
          {"Fecha evento"}
        </tspan>
      </text>
    ...
    <g transform="translate(-140 -79.981)">
      ...
      />
      <text className="d-july" transform="translate(182 893)">
        <tspan x={0} y={0}>
          {"Fecha de hoy"}
        </tspan>
      </text>
    ...
    <g transform="translate(-210.89 -41.981)">
      <g transform="translate(1440.747 906.884)">
        <g className="u-july" transform="matrix(1, 0, 0, 1, -1229.86, -864.9)">
          <path
            className="f-july"
      ...
      <g transform="translate(1224.426 906.884)">
        <g className="t-july" transform="matrix(1, 0, 0, 1, -1013.54, -864.9)">
          <path
            className="f-july"
    ...
    <text className="h-july" transform="translate(1149.135 126.019)">
      <tspan x={0} y={0}>
        {"Julio"}
      </tspan>
    </text>
    <g transform="translate(-140 -133.981)">
      <g className="i-july" transform="translate(140 557)">
        <g transform="translate(-140 -557)">
          <text className="j-july" transform="translate(140 557)">
            <tspan x={-21.712} y={30}>
              {"Do"}
            </tspan>
          </text>
      ...
      <g className="k-july" transform="translate(140 610)">
        <g transform="translate(-140 -557)">
          <text className="l-july" transform="translate(140 557)">
            <tspan x={-14.7} y={23}>
              {"30"}
            </tspan>
          </text>
      ...
      <text className="m-july" transform="translate(140 525)">
        <tspan x={0} y={0}>
          {"Julio 2024"}
        </tspan>
      </text>
      <line className="n-july" x2={567} transform="translate(140 546)" />
      <path
        className="b-july"
        d="M13.947,0,27.893,23.908H0Z"
    ...
    <g className="s-july" transform="matrix(1, 0, 0, 1, 0, 0)">
      <path
        className="g-july"
    ...
    <g className="r-july" transform="matrix(1, 0, 0, 1, 0, 0)">
      <path
        className="g-july"
    ...
    <text className="p-july" transform="translate(1436 743.961)">
      <tspan x={-344.008} y={0}>
