...
const September: React.FC<ICalendar> = ({ next, prev, onChangeMonth, onLessMonth }): JSX.Element => {
  /** Variables */
    ...
    <React.Fragment>
      <svg viewBox="-150 0 1920 998.106">
        <defs>
          <style>
            {
              ".a-september,.n-september{fill:none;}.b-september,.l-september,.o-september,.p-september{fill:#001f5f;}.c-september{fill:#c5dbf7;}.d-september,.j-september,.m-september{fill:#182856;}.d-september,.l-september{font-size:24px;}.d-september{font-family:Silka-Regular, Silka;}.e-september{fill:#e40032;}.f-september{fill:#c7c7cc;}.g-september,.h-september{fill:#fff;}.h-september,.m-september{font-size:42px;}.h-september,.j-september,.m-september{font-family:Silka-SemiBold, Silka;font-weight:600;}.i-september{clip-path:url(#e-september);}.j-september{font-size:32px;}.k-september{clip-path:url(#f-september);}.l-september{font-family:Silka-Medium, Silka;font-weight:500;}.n-september{stroke:#e40032;stroke-width:3px;}.o-september{font-size:55px;}.o-september,.p-september{font-family:Kiona-Bold, Kiona;font-weight:700;}.p-september{font-size:28px;}.q-september{clip-path:url(#k-september);}.r-september{filter:url(#i-september);}.s-september{filter:url(#g-september);}.t-september{filter:url(#c-september);}.u-september{filter:url(#a-september);}"
            }
          </style>
          <filter
            id="a-september"
          ...
          <clipPath id="e-september">
            <rect className="a-september" width={567} height={40} />
          </clipPath>
          <clipPath id="f-september">
            <rect className="a-september" width={567} height={232} />
          </clipPath>
          <filter
            id="g-september"
            x={819}
          ...
          <clipPath id="k-september">
            <rect className="a-september" width={492.426} height={137.787} />
          </clipPath>
        </defs>
        <path
          className="b-september"
        ...
        <g transform="translate(-120 -79.981)">
          <circle
            className="c-september"
            cx={17.5}
            cy={17.5}
            r={17.5}
            transform="translate(416 867)"
          />
          <text className="d-september" transform="translate(458 893)">
            <tspan x={0} y={0}>
              {t("Fecha evento")}
            </tspan>
          </text>
        ...
        <g transform="translate(-120 -79.981)">
          <circle
            className="e-september"
            cx={17.5}
            cy={17.5}
            r={17.5}
            transform="translate(140 867)"
          />
          <text className="d-september" transform="translate(182 893)">
            <tspan x={0} y={0}>
              {t("Fecha de hoy")}
            </tspan>
          </text>
        ...
        <g transform="translate(-210.89 -41.981)">
          <g transform="translate(1440.747 906.884)" onClick={next}>
            <g className="u-september" transform="matrix(1, 0, 0, 1, -1229.86, -864.9)">
              <path
                className="f-september"
          ...
          <g transform="translate(1224.426 906.884)" onClick={prev}>
            <g className="t-september" transform="matrix(1, 0, 0, 1, -1013.54, -864.9)">
              <path
                className="f-september"
        ...
        <text className="h-september" transform="translate(1064.437 126.019)">
          <tspan x={0} y={0}>
            {t("Septiembre")}
          </tspan>
        </text>
        <g transform="translate(-140 -133.981)">
          <g className="i-september" transform="translate(140 557)">
            <g transform="translate(-120 -557)">
              <text className="j-september" transform="translate(140 557)">
                <tspan x={-21.712} y={30}>
                  {t("Do")}
                </tspan>
              </text>
          ...
          <g className="k-september" transform="translate(140 610)">
            <g transform="translate(-120 -557)">
              <circle
              ...
              />
              <text className="l-september" transform="translate(140 557)">
                <tspan x={-12.324} y={23}>
                  {"01"}
                </tspan>
              </text>
          ...
          <text className="m-september" transform="translate(140 525)">
            <tspan x={0} y={0}>
              {t("Septiembre 2024")}
            </tspan>
          </text>
          <line className="n-september" x2={567} transform="translate(140 546)" />
          <path
            className="b-september"
            d="M13.947,0,27.893,23.908H0Z"
        ...
        <text className="o-september" transform="translate(0 185.019)">
          <tspan x={0} y={55}>
            {t("Prográmese con ")}
          </tspan>
          <tspan x={0} y={112}>
        ...
        <g className="s-september" transform="matrix(1, 0, 0, 1, 0, 0)">
          <path
            className="g-september"
        ...
        <g className="r-september" transform="matrix(1, 0, 0, 1, 0, 0)">
          <path
            className="g-september"
        ...
        <text className="p-september" transform="translate(1436 743.961)">
          <tspan x={-344.008} y={0}>
        ...
        <g transform="translate(940.574 398.732)">
          <g className="q-september">
            ...
            <path
              ...
              transform="translate(-550.051 -105.654)"
            />
            <path
              className="b-september"
