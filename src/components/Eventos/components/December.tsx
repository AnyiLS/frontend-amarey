    ...
    <React.Fragment>
      <svg viewBox="-200 0 1920 998.106">
        <defs>
          <style>
            {
              ".a-december,.n-december{fill:none;}.b-december,.l-december,.o-december,.p-december{fill:#001f5f;}.c-december{fill:#c5dbf7;}.d-december,.j-december,.m-december{fill:#182856;}.d-december,.l-december{font-size:24px;}.d-december{font-family:Silka-Regular, Silka;}.e-december{fill:#e40032;}.f-december{fill:#c7c7cc;}.g-december,.h-december{fill:#fff;}.h-december,.m-december{font-size:42px;}.h-december,.j-december,.m-december{font-family:Silka-SemiBold, Silka;font-weight:600;}.i-december{clip-path:url(#e-december);}.j-december{font-size:32px;}.k-december{clip-path:url(#f-december);}.l-december{font-family:Silka-Medium, Silka;font-weight:500;}.n-december{stroke:#e40032;stroke-width:3px;}.o-december{font-size:55px;}.o-december,.p-december{font-family:Kiona-Bold, Kiona;font-weight:700;}.p-december{font-size:28px;}.q-december{clip-path:url(#k-december);}.r-december{filter:url(#i-december);}.s-december{filter:url(#g-december);}.t-december{filter:url(#c-december);}.u-december{filter:url(#a-december);}"
            }
          </style>
          <filter
            id="a-december"
          ...
          <clipPath id="e-december">
            <rect className="a-december" width={567} height={40} />
          </clipPath>
          <clipPath id="f-december">
            <rect className="a-december" width={567} height={232} />
          </clipPath>
          <filter
            id="g-december"
            x={819}
          ...
          <clipPath id="k-december">
            <rect className="a-december" width={492.426} height={137.787} />
          </clipPath>
        </defs>
        <path
        ...
        <g transform="translate(-140 -79.981)">
          ...
          />
          <text className="d-december" transform="translate(458 893)">
            <tspan x={0} y={0}>
              {"Fecha evento"}
            </tspan>
          </text>
        ...
        <g transform="translate(-140 -79.981)">
          ...
          />
          <text className="d-december" transform="translate(182 893)">
            <tspan x={0} y={0}>
              {"Fecha de hoy"}
            </tspan>
          </text>
        ...
        <text className="h-december" transform="translate(1079.437 126.019)">
          <tspan x={0} y={0}>
            {"Diciembre"}
          </tspan>
        </text>
        <g transform="translate(-140 -133.981)">
          ...
          <text className="m-december" transform="translate(140 525)">
            <tspan x={0} y={0}>
              {"Diciembre 2024"}
            </tspan>
          </text>
          <line className="n-december" x2={567} transform="translate(140 546)" />
          <path
            className="b-december"
            d="M13.947,0,27.893,23.908H0Z"
        ...
        <g className="s-december" transform="matrix(1, 0, 0, 1, 0, 0)">
          <path
            className="g-december"
        ...
        <g className="r-december" transform="matrix(1, 0, 0, 1, 0, 0)">
          <path
            className="g-december"
        ...
        <text className="p-december" transform="translate(1436 743.961)">
          <tspan x={-344.008} y={0}>
