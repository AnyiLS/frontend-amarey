...
const May18: React.FC<ICalendar> = ({ next, prev, today, onChangeDay, onChangeMonth, onLessMonth }) => {
  /** Variables */
    ...
    <svg viewBox="-150 0 1920 998.106">
      ...
      <g transform="translate(-210.89 -41.981)">
        <g transform="translate(1440.747 906.884)" onClick={next}>
          <g className="u-item-1813 cursor-pointer" transform="matrix(1, 0, 0, 1, -1229.86, -864.9)">
            <path
              className="j-item-1813 cursor-pointer"
          ...
          <path
            className="e-item-1813 cursor-pointer"
        ...
        <g transform="translate(1224.426 906.884)" onClick={prev}>
          <g className="t-item-1813 cursor-pointer" transform="matrix(1, 0, 0, 1, -1013.54, -864.9)">
            <path
              className="j-item-1813 cursor-pointer"
