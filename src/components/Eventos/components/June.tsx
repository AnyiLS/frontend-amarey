...
const June: React.FC<ICalendar> = ({next, prev}): JSX.Element => {
	/** Variables */
		...
		<React.Fragment>
			<svg viewBox="-200 0 1920 998.106">
				<defs>
					<style>
						{
							'.a-june,.n-june{fill:none;}.b-june,.l-june,.o-june,.p-june{fill:#001f5f;}.c-june{fill:#c5dbf7;}.d-june,.j-june,.m-june{fill:#182856;}.d-june,.l-june{font-size:24px;}.d-june{font-family:Silka-Regular, Silka;}.e-june{fill:#e40032;}.f-june{fill:#c7c7cc;}.g-june,.h-june{fill:#fff;}.h-june,.m-june{font-size:42px;}.h-june,.j-june,.m-june{font-family:Silka-SemiBold, Silka;font-weight:600;}.i-june{clip-path:url(#e-june);}.j-june{font-size:32px;}.k-june{clip-path:url(#f-june);}.l-june{font-family:Silka-Medium, Silka;font-weight:500;}.n-june{stroke:#e40032;stroke-width:3px;}.o-june{font-size:55px;}.o-june,.p-june{font-family:Kiona-Bold, Kiona;font-weight:700;}.p-june{font-size:28px;}.q-june{clip-path:url(#k-june);}.r-june{filter:url(#i-june);}.s-june{filter:url(#g-june);}.t-june{filter:url(#c-june);}.u-june{filter:url(#a-june);}'
						}
					</style>
					<filter
						id="a-june"
					...
					<clipPath id="e-june">
						<rect className="a-june" width={567} height={40} />
					</clipPath>
					<clipPath id="f-june">
						<rect className="a-june" width={567} height={272} />
					</clipPath>
					<filter
						id="g-june"
						x={819}
				...
				<g transform="translate(-140 -133.981)">
					<g className="i-june" transform="translate(140 557)">
					...
					<g className="k-june" transform="translate(140 610)">
						<g transform="translate(-120 -557)">
							<text
								className="l-june"
								transform="translate(140 557)"
				...
				<g className="r-june" transform="matrix(1, 0, 0, 1, 0, 0)">
					<path
						className="g-june"
				...
				<text className="p-june" transform="translate(1436 743.961)">
					<tspan x={-344.008} y={0}>
