...
const June: React.FC<CalendarProps> = ({ onNext, onPrev, onNextMonth, onPrevMonth }): JSX.Element => {
    /** Variables */
    ...
    return (
        <svg viewBox="18 0 414 856.142">
            ...
            <text className="g-mobile" transform="translate(201.806 87.21)">
                <tspan x={0} y={0}>
                    {"Junio"}
                </tspan>
            </text>
