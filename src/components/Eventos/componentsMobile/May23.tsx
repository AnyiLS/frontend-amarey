...
const May23: React.FC<CalendarProps> = ({
	onNext,
	onPrev,
	onNextMonth,
	onPrevMonth,
		...
		<svg viewBox="18 0 414 856.142">
			<defs>
				...
				<clipPath id="f-pentagrama">
					<rect className="a-pentagrama" width={322} height={26} />
				</clipPath>
				<clipPath id="g-pentagrama">
					<rect className="a-pentagrama" width={322} height={165} />
				</clipPath>
				<pattern
					id="h-pentagrama"
			...
			<g transform="translate(148.642 415.209)">
				<g transform="translate(93.329 0)" onClick={() => setView('24-05')}>
					<g
				...
				<g transform="translate(0 0)" onClick={() => setView('22-05')}>
					<g
			...
			<g className="u-pentagrama" transform="matrix(1, 0, 0, 1, 0, 0)">
				<path
			...
			<g className="t-pentagrama" transform="matrix(1, 0, 0, 1, 0, 0)">
				<path
					className="g-pentagrama"
