	...
	return (
		<svg viewBox="0 0 414 1534.99">
			<defs>
				<style>
					{
						'.a-pentagrama{fill:none;}.b-pentagrama{clip-path:url(#a-pentagrama);}.c-pentagrama{fill:#e7002a;stroke:#e7002a;}.d-pentagrama,.e-pentagrama,.g-pentagrama,.h-pentagrama{fill:#001f5f;}.d-pentagrama{stroke:#001f5f;}.e-pentagrama,.l-pentagrama,.r-pentagrama{font-size:14px;}.e-pentagrama,.l-pentagrama,.o-pentagrama,.r-pentagrama{font-family:Silka-Regular, Silka;}.f-pentagrama{font-family:Silka-SemiBold, Silka;font-weight:600;}.g-pentagrama{font-size:32px;}.g-pentagrama,.t-pentagrama{font-family:Kiona-Bold, Kiona;}.g-pentagrama,.q-pentagrama,.t-pentagrama{font-weight:700;}.i-pentagrama{fill:url(#d-pentagrama);}.j-pentagrama{fill:url(#e-pentagrama);}.k-pentagrama,.l-pentagrama,.q-pentagrama,.t-pentagrama{fill:#fff;}.m-pentagrama{fill:url(#l-pentagrama);}.n-pentagrama{fill:url(#q-pentagrama);}.o-pentagrama{fill:#182856;font-size:12px;}.p-pentagrama{fill:url(#t-pentagrama);}.q-pentagrama{font-size:24px;font-family:Silka-Bold, Silka;}.r-pentagrama{font-weight:400;}.s-pentagrama{fill:#e40032;}.t-pentagrama{font-size:8px;}.u-pentagrama{filter:url(#y-pentagrama);}.v-pentagrama{filter:url(#w-pentagrama);}.w-pentagrama{filter:url(#u-pentagrama);}.x-pentagrama{filter:url(#r-pentagrama);}.y-pentagrama{filter:url(#o-pentagrama);}.z-pentagrama{filter:url(#m-pentagrama);}.aa-pentagrama{filter:url(#j-pentagrama);}.ab-pentagrama{filter:url(#h-pentagrama);}.ac-pentagrama{filter:url(#f-pentagrama);}.ad-pentagrama{filter:url(#b-pentagrama);}'
					}
				</style>
