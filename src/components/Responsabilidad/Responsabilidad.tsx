				...
				<div>
					<svg
						...
						<g transform='translate(0 -100)'>
							<text
								className="d-res"
								transform="translate(243 590.268)">
								<tspan x={0} y={23}>
									{t('La ')}
								</tspan>
							...
							<text
								className="f-res"
								transform="translate(243 389.268)">
								<tspan x={0} y={70}>
									{t('RESPONSABILIDAD ')}
								</tspan>
								<tspan x={0} y={142}>
					...
					<svg viewBox="0 780 1920 935">
						...
						<a
							...
							<g
								...
								<text
									...
									transform={
										selectedLanguage === 'es'
											? 'translate(38.43 45.51)'
											: 'translate(53.43 45.51)'
									}
									style={{
										fontSize:
											selectedLanguage === 'es' ? 28 : 26,
									}}>
									<tspan x={0} y={0}>
						...
						<text
							className="n-respo"
							transform="translate(767.787 968.31)">
							<tspan x={0} y={23}>
								{t('Cree en la ')}
							</tspan>
							<tspan x={0} y={51}>
						...
						<text
							className="p-respo"
							transform="translate(263 982.31)">
