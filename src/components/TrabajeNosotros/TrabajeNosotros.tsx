      ...
      {width > 768 ? (
        <svg viewBox="0 50 1925 1300" width="100%" height={"100%"}>
          <defs>
            ...
            <clipPath id="a-trabajo">
              <rect className="a-trabajo" width={1925} height={1718} />
            </clipPath>
            <pattern
              id="b-trabajo"
              width={1}
          ...
          <g transform="translate(15 0)">
            ...
            />
            <text className="f-trabajo" transform="translate(281 488)">
              <tspan x={0} y={42}>
                {t("¿Por qué unirte a nosotros?")}
              </tspan>
            </text>
            <text className="f-trabajo" transform="translate(559 997)">
              <tspan x={0} y={42}>
                {t("Como unirse?")}
              </tspan>
            </text>
            <text className="g-trabajo" transform="translate(960 1216)">
              <tspan x={-357.042} y={42}>
                {t("\xA1Esperamos conocerte pronto!")}
              </tspan>
            </text>
            <text className="h-trabajo" transform="translate(281 571)">
              <tspan x={0} y={23}>
                {t(
            ...
            <text className="h-trabajo" transform="translate(281 677)">
              <tspan x={0} y={23}>
                {t(
              ...
              <tspan className="j-trabajo" y={101} xmlSpace="preserve">
                {t(" logro de nuestros objetivos.")}
              </tspan>
            </text>
            <text className="h-trabajo" transform="translate(559 1092)">
              <tspan x={0} y={23}>
                {t(
              ...
              <a href="mailto:atracciondetalento@grupoamarey.com">
                <tspan className="k-trabajo" y={49} style={{ fill: "#e40032" }}>
                  {t("atracciondetalento@grupoamarey.com")}
                </tspan>
              </a>
              <tspan y={49}>{t(", indicando la ciudad donde vives.")}</tspan>
            </text>
            <text className="l-trabajo" transform="translate(281 294)">
              <tspan x={0} y={38}>
            ...
            />
            <text className="h-trabajo" transform="translate(281 823)">
              <tspan x={0} y={23}>
              ...
              <tspan className="j-trabajo" y={49} xmlSpace="preserve">
        ...
        <svg viewBox="36 0 414 1215">
          <defs>
            ...
            <clipPath id="a-trabajo">
              <rect className="a-trabajo" width={423} height={1423} />
            </clipPath>
            <pattern
              id="b-trabajo"
              width={1}
          ...
          />
          <text className="h-trabajo" transform="translate(73 324.21)">
            <tspan x={0} y={21}>
          ...
          <text className="i-trabajo" transform="translate(69 453.21)">
            <tspan x={0} y={18}>
              {t("\xBFPor qu\xE9 unirte a nosotros?")}
            </tspan>
          </text>
          <text className="i-trabajo" transform="translate(73 832.21)">
            <tspan x={0} y={18}>
              {t("\xBFC\xF3mo unirse?")}
            </tspan>
          </text>
          <text className="j-trabajo" transform="translate(73 495.21)">
            <tspan x={0} y={13}>
          ...
          <text className="j-trabajo" transform="translate(73 570.21)">
            <tspan x={0} y={13}>
            ...
            <tspan className="l-trabajo" y={109} xmlSpace="preserve">
              {t(" logro de ")}
            </tspan>
          ...
          <text className="j-trabajo" transform="translate(73 708.21)">
            <tspan x={0} y={13}>
              {t("Estamos en b\xFAsqueda de personas")}
            </tspan>
          ...
          <text className="j-trabajo" transform="translate(73 864.21)">
            <tspan x={0} y={13}>
          ...
          <text className="o-trabajo" transform="translate(245 958.21)">
