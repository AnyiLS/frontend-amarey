...
const Noticias = () => {
  ...
  const {width} = useGeneral()
	...
	return (
		<div>
       {
		width > 768 ? (
			...
			<g className="f-products-desktop" transform="translate(5 93)">
				<rect
	...
	{ notiicasMocks(t)[page].text() }
			<g transform="translate(1676 446.038)" onClick={() => setPage(page + 1 > 2 ? 0 : page + 1)}>
				<g
			...
			<g transform="translate(147 446.038)" onClick={() => setPage(page - 1 > 2 ? 0 : page - 1)}>
				<g
			...
			<circle
				className={`r-products-desktop ${page === 1 ? 'selected' : ''}`}
				cx={14}
				cy={14}
				r={14}
	  ...
	  onClick={() => setPage(1)}
			/>
			<circle
				className={`r-products-desktop ${page === 2 ? 'selected' : ''}`}
				cx={14}
				cy={14}
				r={14}
	  ...
	  onClick={() => setPage(2)}
			/>
			<circle
				className={`r-products-desktop ${page === 0 ? 'selected' : ''}`}
				cx={14}
				cy={14}
				r={14}
	  ...
	  onClick={() => setPage(0)}
			/>
			<g transform="translate(810 704.921)" className='redireciona'>
				<g
