...
export const Slider4: React.FC<ISlider> = ({ height, index, onOpenVideo }) => {
		...
		<div className="relative">
			<svg
				...
				<g transform="translate(0 5.702)">
					...
					<g
						className="hover"
						transform="translate(1041.413 839.033)">
						<g
					...
					<g
						transform="translate(1408.886 839.033)"
						className="hover">
						<g
