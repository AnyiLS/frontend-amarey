...
export const Slider4: React.FC<ISlider> = ({ index, onOpenVideo }) => {
      ...
      >
        <defs>
          ...
          <clipPath id="s-item-1820">
            <g className="aa-item-1820" transform="matrix(1, 0, 0, 1, 0, 0)">
              <path
        ...
        <g transform="translate(0 5.702)">
          ...
          <text className="g-item-1820" transform="translate(142 162.191)">
            <tspan x={0} y={65}>
              {t("Servicio - 3")}
            </tspan>
            <tspan x={0} y={132}>
          ...
          <g transform="translate(191.527 408.7)" className="hover">
            ...
            <text className="m-item-1820" transform="translate(178.236 15.436)">
              <tspan x={-87.576} y={23}>
                {t("Nuestra red en")}
              </tspan>
              <tspan x={selectedLanguage === "es" ? -131.352 : -111.352} y={49}>
              ...
              <tspan
                x={selectedLanguage === "es" ? -126.996 : -116.996}
                y={101}
              >
              ...
              <tspan
                ...
                x={selectedLanguage === "es" ? -142.632 : -77.632}
                y={127}
              >
          ...
          <g className="hover" transform="translate(1041.413 839.033)">
            ...
            <text className="m-item-1820" transform="translate(175 43.436)">
              <tspan x={selectedLanguage === 'es' ? -97.74 : -70.74} y={23}>
                {t("Seguimiento por")}
              </tspan>
              <tspan className="n-item-1820" x={selectedLanguage === 'es' ? -120.852 : -73.852} y={49}>
                {t("GPS para garantizar")}
              </tspan>
              <tspan className="n-item-1820" x={selectedLanguage === 'es' ? -61.476 : -50.476} y={75}>
                {t("la entrega")}
              </tspan>
            </text>
          </g>
            ...
            <text className="p-item-1820" transform="translate(188.057 43.435)">
              ...
              {selectedLanguage === "en" && (
                <tspan className="n-item-1820" x={19.548} y={23}>
                  {t("máximo 4 horas").split(" ")[0]}
                </tspan>
              )}
              <tspan className="n-item-1820" x={selectedLanguage === 'es' ? -133.452 : -163.452} y={51}>
                {selectedLanguage === 'en' ? t("máximo 4 horas").split(' ')[1] : t("máximo 4 horas")}
              </tspan>
              <tspan y={51} xmlSpace="preserve">
                {t(" en las ")}
              </tspan>
              <tspan className="p-item-1820" x={selectedLanguage === 'es' ? -124.26 : -155.26} y={79}>
          ...
          <g transform="translate(1408.886 839.033)" className="hover">
            ...
            <text className="m-item-1820" transform="translate(188.557 29.436)">
              ...
              <tspan className="n-item-1820" x={selectedLanguage === 'es' ? -122.352 : -100.352} y={75}>
                {t("Colombia, Panamá y")}
              </tspan>
              <tspan className="n-item-1820" x={selectedLanguage === 'es' ? -65.712 : -75.712} y={101}>
                {t("Costa Rica")}
              </tspan>
            </text>
          </g>
          <g transform="translate(648.473 839.033)" className="hover">
            <g transform="translate(328.939 -3270.703)">
              ...
              >
                <tspan x={selectedLanguage === 'es' ? -82.476 : -65.476} y={23}>
                  {t("Trazabilidad y")}
                </tspan>
                <tspan x={selectedLanguage === 'es' ? -93.984 : -69.984} y={49}>
                  {t("monitoreo de la")}
                </tspan>
                <tspan className="n-item-1820" x={selectedLanguage === 'es' ? -87.492 : -90.492} y={75}>
                  {t("cadena de frío")}
                </tspan>
              </text>
            </g>
          </g>
          <g className="t-item-1820" transform="matrix(1, 0, 0, 1, 0, -5.7)">
            <path
          ...
          <g transform="translate(634 -6)">
            <path
              ...
              d="M0,0,83.578,495.042c23.951,141.871,77.734,234.4,228.41,234.4h989.9V0Z"
              onClick={() => onOpenVideo && onOpenVideo()}
            />
          </g>
