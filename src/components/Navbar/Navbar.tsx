        ...
        <g>
          ...
          >
            <foreignObject x={0} y={0} width={37} height={37}>
              <img src="/images/lupa.svg" alt="" className="h-full w-full" />
            </foreignObject>
          </g>
          <g
            ...
            onClick={() =>
              setHover(hover === "contactenos" ? "" : "contactenos")
            }
          >
            <rect
              ...
              height={76}
              style={{
                fill: hover1 === "contactenos" ? "#001F5F" : "transparent",
              }}
            />
            <text
              ...
              style={{
                fill: hover1 !== "contactenos" ? "#001F5F" : "#fff",
              }}
            >
              <tspan x={-58.905} y={0}>
                {selectedLanguage === "es"
                  ? t("Cont\xE1ctenos")
                  : t("Cont\xE1ctenos").split(" ").slice(0, 3).join(" ")}
              </tspan>
              {selectedLanguage === "en" && (
                <tspan x={-34.905} y={20}>
                  {t("Cont\xE1ctenos").split(" ").slice(3, 5).join(" ")}
                </tspan>
              )}
            </text>
            {hover1 === "contactenos" && (
          ...
          >
            <path
              ...
              style={{
                fill: hover1 === "trabaje" ? "#001F5F" : "transparent",
              }}
            />
            <text
            ...
            >
              <tspan x={selectedLanguage === "es" ? -33.246 : -21.246} y={0}>
                {t("Trabaje")}
              </tspan>
              <tspan x={selectedLanguage === "es" ? -58.725 : -30.725} y={20}>
                {t("con nosotros")}
              </tspan>
            </text>
            {hover1 === "trabaje" && (
          ...
          >
            <rect
              ...
              height={76}
              style={{
                fill: hover1 === "etica" ? "#001F5F" : "transparent",
              }}
            />
            <text
            ...
            >
              <tspan x={selectedLanguage === "es" ? -30.114 : -45.114} y={0}>
                {t("\xC9tica y")}
              </tspan>
              <tspan x={selectedLanguage === "es" ? -51.912 : -51.912} y={20}>
                {t("compliance\u200B")}
              </tspan>
            </text>
            {hover1 === "etica" && (
          ...
          >
            <path
              ...
              d="M0,0H117V76H0Z"
              style={{
                fill: hover1 === "actualidad" ? "#001F5F" : "transparent",
              }}
            />
            <text
            ...
            >
              ...
              {selectedLanguage === "en" && (
                <tspan x={-38.555} y={20}>
                  {t("Actualidad\u200B").split(" ").slice(2, 3).join(" ")}
                </tspan>
              )}
            </text>
            {hover1 === "actualidad" && (
          ...
          >
            <rect
              ...
              height={76}
              style={{
                fill: hover1 === "solucion" ? "#001F5F" : "transparent",
              }}
            />
            <text
              ...
              style={{
                fill: hover1 === "solucion" ? "#fff" : "#001F5F",
              }}
            >
              <tspan x={selectedLanguage === "es" ? -47.772 : -27} y={0}>
                {t("Soluciones")}
              </tspan>
              <tspan x={-37.935} y={20}>
                {t("en salud\u200B")}
          ...
          <g
            ...
            onClick={() =>
              setHover(hover === "trayectoria" ? "" : "trayectoria")
            }
          >
            <rect
              ...
              height={76}
              style={{
                fill: hover1 !== "trayectoria" ? "transparent" : "#001F5F",
              }}
            />
            <text
              ...
              style={{
                fill: hover1 === "trayectoria" ? "#fff" : "#001F5F",
              }}
            >
              <tspan x={selectedLanguage === "es" ? -50.697 : -42.697} y={0}>
                {t("Trayectoria")}
              </tspan>
            </text>
            {hover1 === "trayectoria" && (
          ...
          <a href="/">
            <g
              ...
              onClick={() => setHover(hover1 === "home" ? "" : "home")}
            >
              <rect
                className="a"
                width={78}
                height={76}
                style={{
                  fill: hover1 === "home" ? "#001F5F" : "transparent",
                }}
              />
              <text
          ...
          <a href="/">
            <g transform="translate(142 26.931)" className="cursor-pointer">
              <g className="h cursor-pointer" transform="translate(0 0)">
                <path
              ...
              >
                ...
                {results.length > 0 && (
                  <div className="w-full h-[200px] bg-white overflow-y-auto">
                    {results.map((item: SiteMapMock, index: number) => (
                      <div
