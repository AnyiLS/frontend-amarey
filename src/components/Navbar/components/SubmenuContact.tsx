    ...
    >
      <defs>
        ...
        <clipPath id="a-submenu-t">
          <rect className="a-submenu-t" width={1427.387} height={206.155} />
        </clipPath>
        <pattern
          id="b-submenu-t"
          width={1}
      ...
      <g transform="translate(0 -104)">
        ...
        <text className="h-submenu-t" transform="translate(292 395)">
          <tspan x={-152.166} y={selectedLanguage === "es" ? 0 : -35}>
            {selectedLanguage === "es"
              ? t("CONTACTENOS")
              : t("CONTACTENOS").split(" ").slice(0, 3).join(" ")}
          </tspan>
          {selectedLanguage === "en" && (
            <tspan x={-152.166} y={15}>
              {t("CONTACTENOS").split(" ").slice(3, 6).join(" ")}
            </tspan>
          )}
        </text>
      </g>
