      ...
      >
        <defs>
          ...
          <clipPath id="a-biomante">
            <rect className="a-biomante" width={1920} height={1718} />
          </clipPath>
          <pattern
            id="b-biomante"
            width={1}
        ...
        <g transform="translate(9)">
          ...
          />
          <text className="f-biomante" transform="translate(1823.349 75)">
            <tspan x={-351.48} y={0}>
              {t("MANTENIMIENTO BIOMÉDICO ")}
            </tspan>
          </text>
          <text className="g-biomante" transform="translate(324.349 177)">
            <tspan x={34.588} y={23}>
              {t(
          ...
          <text className="h-biomante" transform="translate(116.349 341)">
            <tspan x={41.052} y={36}>
              {t("12.000 equipos")}
            </tspan>
            <tspan className="d-biomante" y={36} xmlSpace="preserve">
              {selectedLanguage === 'es' ? t(" de marcas representadas ") : t(" de marcas representadas ").split(' ').slice(0,5).join(' ')}
            </tspan>
            {selectedLanguage === "en" && (
              <tspan className="d-biomante" x={350} y={72} xmlSpace="preserve">
                {t(" de marcas representadas ").split(' ').slice(5,9).join(' ')}
              </tspan>
            )}
          </text>
          <text className="g-biomante" transform="translate(243.349 314)">
            <tspan x={26.964} y={23}>
              {t("Atendemos una capacidad instalada cercana a los ")}
            </tspan>
          </text>
          <text className="g-biomante" transform="translate(1097.349 342)">
            <tspan x={25.896} y={23}>
              {t("dedicados al cuidado de la tecnolog\xEDa biom\xE9dica y ")}
            </tspan>
            <tspan x={selectedLanguage === "es" ? 32.016 : 112.016} y={49}>
              {t("comprometidos con la seguridad de los pacientes ")}
            </tspan>
          </text>
          <text className="i-biomante" transform="translate(1019.349 287)">
            <tspan x={selectedLanguage === "es" ? 67.851 : 127.851} y={40}>
              {t("Contamos con ")}
            </tspan>
          ...
          <g className="n-biomante" transform="matrix(1, 0, 0, 1, -9, 0)">
            <path
          ...
          <g className="m-biomante" transform="matrix(1, 0, 0, 1, -9, 0)">
            <path
